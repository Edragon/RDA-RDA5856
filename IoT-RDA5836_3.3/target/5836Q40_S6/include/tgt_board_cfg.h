...
{                                                              \
    ...
    { HAL_GPIO_0_1,  HAL_GPIO_DIRECTION_INPUT, HAL_GPIO_ALTFUNC_CFG_1, HAL_GPIO_UP_DOWN_QTY, NONEED, FALSE,  1, {FALSE, FALSE, FALSE, FALSE}, NULL},/* usb_dp */  \
    { HAL_GPIO_0_2,  HAL_GPIO_DIRECTION_INPUT, HAL_GPIO_ALTFUNC_CFG_1, HAL_GPIO_UP_DOWN_QTY, NONEED, FALSE,   2, {FALSE, TRUE, FALSE, FALSE}, NULL},/* keysense */   \
    { HAL_GPIO_0_3,  HAL_GPIO_DIRECTION_INPUT, HAL_GPIO_ALTFUNC_CFG_0, HAL_GPIO_UP_DOWN_QTY, NONEED, FALSE,   3,{FALSE, FALSE, FALSE, FALSE}, NULL},/* D3 */ \
    ...
    { HAL_GPIO_0_7,  HAL_GPIO_DIRECTION_INPUT, HAL_GPIO_ALTFUNC_CFG_0, HAL_GPIO_UP_DOWN_QTY, NONEED, FALSE,  7, {FALSE, FALSE, FALSE, FALSE}, NULL}, \
    ...
    { HAL_GPIO_1_4,  HAL_GPIO_DIRECTION_INPUT, HAL_GPIO_ALTFUNC_CFG_10, HAL_GPIO_UP_DOWN_QTY, NONEED, FALSE,  12,   {FALSE,  FALSE,  FALSE,  FALSE}, NULL},\
    { HAL_GPIO_1_5,  HAL_GPIO_DIRECTION_OUTPUT, HAL_GPIO_ALTFUNC_CFG_10, HAL_GPIO_UP_DOWN_QTY, NONEED, FALSE,  13, {FALSE, FALSE, FALSE, FALSE}, NULL}, /* i2s bclk */\
}
...
{                                                              \
     /*    id             in or out                   cfg0-cfg9         up or down      drv strength enint  gpio intnum     irqmask           irqhandler  */  \
    { HAL_GPIO_0_0,  HAL_GPIO_DIRECTION_INPUT, HAL_GPIO_ALTFUNC_CFG_0, HAL_GPIO_UP_DOWN_QTY, NONEED, FALSE,  0, {FALSE, FALSE, FALSE, FALSE}, NULL},/* usb_dn */  \
    { HAL_GPIO_0_1,  HAL_GPIO_DIRECTION_INPUT, HAL_GPIO_ALTFUNC_CFG_9, HAL_GPIO_UP_DOWN_QTY, NONEED, FALSE,  1, {FALSE, FALSE, FALSE, FALSE}, NULL},/* usb_dp */  \
    { HAL_GPIO_0_2,  HAL_GPIO_DIRECTION_INPUT, HAL_GPIO_ALTFUNC_CFG_9, HAL_GPIO_UP_DOWN_QTY, NONEED, FALSE,   2, {FALSE, TRUE, FALSE, FALSE}, NULL},/* keysense */   \
    { HAL_GPIO_0_3,  HAL_GPIO_DIRECTION_INPUT, HAL_GPIO_ALTFUNC_CFG_0, HAL_GPIO_UP_DOWN_QTY, NONEED, FALSE,   3,{FALSE, FALSE, FALSE, FALSE}, NULL},/* D3 */ \
    { HAL_GPIO_0_4,  HAL_GPIO_DIRECTION_INPUT, HAL_GPIO_ALTFUNC_CFG_4, HAL_GPIO_UP_DOWN_QTY, NONEED, FALSE,   4,{FALSE,  FALSE,  FALSE,  FALSE}, NULL},/* D5 */ \
    { HAL_GPIO_0_5,  HAL_GPIO_DIRECTION_INPUT, HAL_GPIO_ALTFUNC_CFG_11, HAL_GPIO_UP, NONEED, TRUE,  5, {TRUE, TRUE, TRUE, FALSE}, gpio_CardDetectHandler}, /* D6*/\
    { HAL_GPIO_0_6,  HAL_GPIO_DIRECTION_INPUT, HAL_GPIO_ALTFUNC_CFG_4, HAL_GPIO_UP_DOWN_QTY, NONEED, FALSE,  6, {FALSE, FALSE, FALSE, FALSE}, NULL},/* D7 */ \
    ...
    { HAL_GPIO_1_0,  HAL_GPIO_DIRECTION_OUTPUT, HAL_GPIO_ALTFUNC_CFG_0, HAL_GPIO_UP_DOWN_QTY, NONEED, FALSE,  8, {FALSE, FALSE, FALSE, FALSE}, NULL}, /* i2c sda */\
    { HAL_GPIO_1_1,  HAL_GPIO_DIRECTION_OUTPUT, HAL_GPIO_ALTFUNC_CFG_0, HAL_GPIO_UP_DOWN_QTY, NONEED, FALSE,  9, {FALSE, FALSE, FALSE, FALSE}, NULL}, /* i2c clk*/\
    { HAL_GPIO_1_2,  HAL_GPIO_DIRECTION_INPUT, HAL_GPIO_ALTFUNC_CFG_10, HAL_GPIO_UP_DOWN_QTY, NONEED, FALSE,  10, {FALSE, FALSE, FALSE, FALSE}, NULL},/* i2s di */\
    { HAL_GPIO_1_3,  HAL_GPIO_DIRECTION_INPUT, HAL_GPIO_ALTFUNC_CFG_10, HAL_GPIO_UP_DOWN_QTY, NONEED, FALSE,  11, {FALSE, FALSE, FALSE, FALSE}, NULL}, /* i2s do */\
    { HAL_GPIO_1_4,  HAL_GPIO_DIRECTION_INPUT, HAL_GPIO_ALTFUNC_CFG_10, HAL_GPIO_UP_DOWN_QTY, NONEED, FALSE,  12,   {FALSE,  FALSE,  FALSE,  FALSE}, NULL},\
    { HAL_GPIO_1_5,  HAL_GPIO_DIRECTION_OUTPUT, HAL_GPIO_ALTFUNC_CFG_10, HAL_GPIO_UP_DOWN_QTY, NONEED, FALSE,  13, {FALSE, FALSE, FALSE, FALSE}, NULL}, /* i2s bclk */\
}
#endif
...
{                                                                         \
 /* power key */    KEY_PLAY,                                            \
 /* gpio keys */     KEY_VOL_UP,    KEY_VOL_DOWN,	    KEY_NEXT,	    KEY_VOL_DOWN,	KEY_MODE,       KEY_PREV,	    KEY_INVALID,	KEY_INVALID,  \
 /* TSC keys  */    KEY_PLAY,    	KEY_PREV, 	KEY_NEXT,		KEY_NEXT,	KEY_VOL_UP,     KEY_VOL_DOWN,	KEY_REC,	    KEY_PLAY,	    KEY_NEXT,	    KEY_EQ,	 \
...
#define TGT_PMD_CONFIG                                                  \
    {                                                                   \
        ...
        .batteryChargeCurrent        = PMD_CHARGER_50MA,               \
        .chargerGpadcChannel         = 6/*HAL_ANA_GPADC_CHAN_6*/,            \
        ...
        .holdPowerOn                 = TRUE,                           \
        .keyPowerOnInterval          = PMD_KEY_POWERON_INTERVAL0       \
    }
