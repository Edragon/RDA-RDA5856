...
#define MIC_GAINS_EP { 15, 0, 0, 0 }
#define MIC_GAINS_LS { 15, 0, 0, 0 }
...
#define DEFAULT_CALIB_AUDIO_VOC_DIGGAIN_PARAM_EP		{ 0x1, 0x1, 0x400, 0x400 }

#define DEFAULT_CALIB_AUDIO_VOC_DIGGAIN_PARAM_LS		{ 0x1, 0x1, 0x400, 0x400 }
...
#define DEFAULT_CALIB_AUDIO_VOC_AEC_PARAM_EP { \
		1, 0, 6, 8, 4, 10, 32, 0, \
		64, 4, 13, 0, 13, 32, 16, 3, \
		2, 26, 0, 16, 0, 1023, 20, \
		{6, 12, 10, 8, 5, 5, 5, 5, 5}, \
		0, 0x7f, 128, 64, 160, 4, 256, \
		128, 64, 6, 160, 16, 16, 122, \
		64, 1, 71, 40, {500, 2000, 5000}, \
		{100, 200, 300, 600}, 0, 0, \
...
{\
{1, 1, 12, 1, 1024, 0, -65, 500, -1000, 512, 1000, 4},\
{1, 1, 15, 1, 1024, 0, -65, 500, -1000, 512, 1000, 4},\
}
...
#define DEFAULT_CALIB_AUDIO_VOC_FIR_PARAM_LS  { 1, 1, DEFAULT_CALIB_MDF_PROFILE_LS, DEFAULT_CALIB_SDF_PROFILE_LS }
