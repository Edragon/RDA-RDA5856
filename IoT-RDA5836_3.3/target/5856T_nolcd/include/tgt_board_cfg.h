...
{                                                                   \
    ...
    .ledHighLight               = TRUE,                            \
    .leds      = {                                                  \
        {.gpioId =HAL_GPIO_NONE},     /* MUSIC */                             \
        {.gpioId =HAL_GPIO_NONE},     /* FM */                                \
        {.gpioId =HAL_GPIO_NONE},     /* Bluetooth */                         \
        {.gpioId =HAL_GPIO_NONE}},                                           \
    .key_count                   = 0,                               \
...
{                                                              \
    ...
    { HAL_GPIO_3_7,  HAL_GPIO_DIRECTION_INPUT, HAL_GPIO_ALTFUNC_CFG_4, HAL_GPIO_UP_DOWN_QTY, NONEED, FALSE,  6,      {FALSE, FALSE, FALSE, FALSE}, NULL}, /* hst txd */\
    { HAL_GPIO_4_0,  HAL_GPIO_DIRECTION_INPUT, HAL_GPIO_ALTFUNC_CFG_4, HAL_GPIO_UP_DOWN_QTY, NONEED, FALSE,  5,      {FALSE, FALSE, FALSE, FALSE}, NULL},/* hst rxd */\
...
{                                                              \
    ...
    { HAL_GPIO_0_1,  HAL_GPIO_DIRECTION_INPUT, HAL_GPIO_ALTFUNC_CFG_7, HAL_GPIO_UP_DOWN_QTY, NONEED, FALSE,  NONEED, {FALSE, FALSE, FALSE, FALSE}, NULL},/* usb_dp */  \
    { HAL_GPIO_0_4,  HAL_GPIO_DIRECTION_INPUT, HAL_GPIO_ALTFUNC_CFG_6, HAL_GPIO_UP_DOWN_QTY, NONEED, TRUE,   7,      {FALSE, TRUE, FALSE, FALSE}, NULL},/* keysense */   \
    { HAL_GPIO_3_7,  HAL_GPIO_DIRECTION_INPUT, HAL_GPIO_ALTFUNC_CFG_0, HAL_GPIO_UP_DOWN_QTY, NONEED, FALSE,  6,      {FALSE, FALSE, FALSE, FALSE}, NULL}, /* hst txd */\
    { HAL_GPIO_4_0,  HAL_GPIO_DIRECTION_INPUT, HAL_GPIO_ALTFUNC_CFG_0, HAL_GPIO_UP_DOWN_QTY, NONEED, FALSE,  5,      {FALSE, FALSE, FALSE, FALSE}, NULL},/* hst rxd */\
    { HAL_GPIO_4_3,  HAL_GPIO_DIRECTION_INPUT, HAL_GPIO_ALTFUNC_CFG_5, HAL_GPIO_UP_DOWN_QTY, NONEED, FALSE,  2,      {FALSE, FALSE, FALSE, FALSE}, NULL},/* sd d0 */ \
