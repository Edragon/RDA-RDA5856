...
#endif
#define APP_SUPPORT_BT_CLOSE_AFTER_QUIT 1
#define APP_SUPPORT_HFP                 1
#define APP_SUPPORT_HID                 0
#define APP_SUPPORT_HID_MODE            0
