...
{                                                              \
    ...
    { HAL_GPIO_1_0,  HAL_GPIO_DIRECTION_OUTPUT, HAL_GPIO_ALTFUNC_CFG_2, HAL_GPIO_UP_DOWN_QTY, NONEED, FALSE,   0, {TRUE,  TRUE,  TRUE,  FALSE}, NULL},/* D3 */ \
    { HAL_GPIO_1_1,  HAL_GPIO_DIRECTION_OUTPUT, HAL_GPIO_ALTFUNC_CFG_2, HAL_GPIO_UP_DOWN_QTY, NONEED, FALSE,   15,          {TRUE,  TRUE,  TRUE,  FALSE}, NULL},/* D5 */ \
    { HAL_GPIO_1_2,  HAL_GPIO_DIRECTION_OUTPUT, HAL_GPIO_ALTFUNC_CFG_2, HAL_GPIO_UP_DOWN_QTY, NONEED, FALSE,  NONEED, {FALSE, FALSE, FALSE, FALSE}, NULL}, /* D6*/\
    { HAL_GPIO_1_3,  HAL_GPIO_DIRECTION_OUTPUT, HAL_GPIO_ALTFUNC_CFG_2, HAL_GPIO_UP_DOWN_QTY, NONEED, FALSE,  14,          {FALSE, FALSE, FALSE, FALSE}, NULL},/* D7 */ \
    ...
    { HAL_GPIO_3_0,  HAL_GPIO_DIRECTION_OUTPUT, HAL_GPIO_ALTFUNC_CFG_0, HAL_GPIO_UP_DOWN_QTY, NONEED, FALSE,  NONEED, {FALSE, FALSE, FALSE, FALSE}, NULL}, /* i2c sda */\
    { HAL_GPIO_3_1,  HAL_GPIO_DIRECTION_OUTPUT, HAL_GPIO_ALTFUNC_CFG_0, HAL_GPIO_UP_DOWN_QTY, NONEED, FALSE,  NONEED, {FALSE, FALSE, FALSE, FALSE}, NULL}, /* i2c clk*/\
