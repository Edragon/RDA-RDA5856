...
//CONST Y
/********************************speex const begin*********************************/
voc_short For_noisesuppress_y_align	,856,y

voc_short SpxPpState_window	,2*SPEEX_NN,y

voc_short SpxPpState_bank_bank_left ,SPEEX_NN,y
//voc_alias SpxPpState_bank	SpxPpState_bank_bank_left,y
voc_short SpxPpState_bank_bank_right	,SPEEX_NN,y
voc_short SpxPpState_bank_filter_left	,SPEEX_NN,y
voc_short SpxPpState_bank_filter_right	,SPEEX_NN,y
voc_short SpxPpState_bank_nb_banks	,y
voc_short SpxPpState_bank_len	,y

voc_alias FILTERBANK_NB_BANKS SpxPpState_bank_nb_banks,y
voc_alias FILTERBANK_LEN	SpxPpState_bank_len,y


voc_short SpxPpState_fft_lookup_forward_substate_nfft	,y
voc_alias SpxPpState_fft_lookup	SpxPpState_fft_lookup_forward_substate_nfft,y
voc_alias SpxPpState_fft_lookup_forward_substate SpxPpState_fft_lookup_forward_substate_nfft,y
voc_short SpxPpState_fft_lookup_forward_substate_inverse	,y
voc_short SpxPpState_fft_lookup_forward_substate_factors	,(2*MAXFACTORS),y
voc_short SpxPpState_fft_lookup_forward_substate_twiddles	,(2*SPEEX_NN),y
voc_short SpxPpState_fft_lookup_forward_tmpbuf	,(2*SPEEX_NN),y
voc_short SpxPpState_fft_lookup_forward_super_twiddles	,(2*SPEEX_NN),y

voc_short SpxPpState_fft_lookup_backward_substate_nfft	,y
voc_alias SpxPpState_fft_lookup_backward_substate SpxPpState_fft_lookup_backward_substate_nfft,y
voc_short SpxPpState_fft_lookup_backward_substate_inverse	,y
voc_short SpxPpState_fft_lookup_backward_substate_factors	,(2*MAXFACTORS),y
voc_short SpxPpState_fft_lookup_backward_substate_twiddles	,(2*SPEEX_NN),y
voc_short SpxPpState_fft_lookup_backward_tmpbuf	,(2*SPEEX_NN),y
voc_short SpxPpState_fft_lookup_backward_super_twiddles	,(2*SPEEX_NN),y

voc_short SpxPpState_fft_lookup_N	,y
voc_short SpxPpState_fft_lookup_reserved,y

// echo_state
voc_short SpxEchoState_window	,2*SPEEX_NN,y
voc_alias SpxEchoState_fft_table	SpxPpState_fft_lookup_forward_substate_nfft,y


voc_word SPEEX_ATAN01_M	,4,y
voc_word SPEEX_COS_PI_2_L	,4,y
voc_short SPEEX_SQRT_C	,4,y
voc_short SPEEX_UPDATE_NOISE_X	,4,y

voc_short SPEEX_HYPERGEOM_GAIN_TABLE	,22,y
voc_short SPEEX_EXP_D	,4,y

voc_word SPEEX_CONST_0	,y
voc_word SPEEX_CONST_1	,y
voc_word SPEEX_CONST_2	,y
voc_word SPEEX_CONST_3	,y
voc_word SPEEX_CONST_4	,y
voc_word SPEEX_CONST_5	,y
voc_word SPEEX_CONST_6	,y
voc_word SPEEX_CONST_7	,y
voc_word SPEEX_CONST_8	,y
voc_word SPEEX_CONST_14	,y

voc_word SPEEX_CONST_16	,y
voc_word SPEEX_CONST_17	,y
voc_word SPEEX_CONST_19 ,y
voc_word SPEEX_CONST_20	,y
voc_word SPEEX_CONST_29	,y
voc_word SPEEX_CONST_64 ,y
voc_word SPEEX_CONST_97	,y
voc_word SPEEX_CONST_100	,y
voc_word SPEEX_CONST_128	,y
voc_word SPEEX_CONST_236	,y

voc_word SPEEX_CONST_256	,y
voc_word SPEEX_CONST_472	,y
voc_word SPEEX_CONST_512	,y
voc_word SPEEX_CONST_983	,y
voc_word SPEEX_CONST_1000	,y
voc_word SPEEX_CONST_2458	,y
voc_word SPEEX_CONST_3277	,y
voc_word SPEEX_CONST_4915	,y
voc_word SPEEX_CONST_6521	,y
voc_word SPEEX_CONST_6711	,y

voc_word SPEEX_CONST_8192	,y
voc_word SPEEX_CONST_9830	,y
voc_word SPEEX_CONST_10000	,y
voc_word SPEEX_CONST_10912	,y
voc_word SPEEX_CONST_16384	,y
voc_word SPEEX_CONST_19458	,y
voc_word SPEEX_CONST_19661	,y
voc_word SPEEX_CONST_20000	,y
voc_word SPEEX_CONST_20839	,y
voc_word SPEEX_CONST_21290	,y

voc_word SPEEX_CONST_21924	,y
voc_word SPEEX_CONST_22938	,y
voc_word SPEEX_CONST_23637	,y
voc_word SPEEX_CONST_24576	,y
voc_word SPEEX_CONST_25736	,y
voc_word SPEEX_CONST_26214	,y
voc_word SPEEX_CONST_29164	,y
voc_word SPEEX_CONST_29458	,y
voc_word SPEEX_CONST_32000	,y
voc_word SPEEX_CONST_32766	,y
voc_word SPEEX_CONST_32767	,y

voc_word SPEEX_CONST_32768	,y
voc_word SPEEX_CONST_65535	,y
voc_word SPEEX_CONST_65536	,y
voc_word SPEEX_CONST_131071	,y
voc_word SPEEX_CONST_131072	,y
voc_word SPEEX_CONST_0x80000	,y
voc_word SPEEX_CONST_1087164	,y
voc_word SPEEX_CONST_0x800000	,y
voc_word SPEEX_CONST_0x7fffffff	,y
voc_word SPEEX_CONST_NEG21290	,y

voc_word SPEEX_CONST_NEG15	,y
voc_word SPEEX_CONST_NEG2	,y
voc_word SPEEX_CONST_NEG32767	,y
