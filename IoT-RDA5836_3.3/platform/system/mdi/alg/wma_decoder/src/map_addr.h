...
#define WMADECODE_GLOBAL_Y_SIZE                           		10048
...
#define WMADECODE_LOCAL_Y_BEGIN_ADDR                      		(10048 + RAM_Y_BEGIN_ADDR)
#define COMMON_LOCAL_X_BEGIN_ADDR                         		(9556 + RAM_X_BEGIN_ADDR)
#define COMMON_LOCAL_Y_BEGIN_ADDR                         		(10048 + RAM_Y_BEGIN_ADDR)
...
#define WMADEC_BAND_INFO_ENABLE_FLAG_ADDR       			(10030 + WMADECODE_GLOBAL_Y_BEGIN_ADDR) //1 short
#define WMADEC_BAND_INFO_RESERVED               			(10031 + WMADECODE_GLOBAL_Y_BEGIN_ADDR) //1 short
//m_WMADEC_BAND_INFO_ADDR
#define m_WMADEC_BAND_INFO_ADDR                 			(10032 + WMADECODE_GLOBAL_Y_BEGIN_ADDR)
#define WMADEC_BAND1_INFO                       			(0 + m_WMADEC_BAND_INFO_ADDR) //2 short
#define WMADEC_BAND2_INFO                       			(2 + m_WMADEC_BAND_INFO_ADDR) //2 short
#define WMADEC_BAND3_INFO                       			(4 + m_WMADEC_BAND_INFO_ADDR) //2 short
#define WMADEC_BAND4_INFO                       			(6 + m_WMADEC_BAND_INFO_ADDR) //2 short
#define WMADEC_BAND5_INFO                       			(8 + m_WMADEC_BAND_INFO_ADDR) //2 short
#define WMADEC_BAND6_INFO                       			(10 + m_WMADEC_BAND_INFO_ADDR) //2 short
#define WMADEC_BAND7_INFO                       			(12 + m_WMADEC_BAND_INFO_ADDR) //2 short
#define WMADEC_BAND8_INFO                       			(14 + m_WMADEC_BAND_INFO_ADDR) //2 short
