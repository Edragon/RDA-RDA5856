...
#ifndef vpp_AudioSbc_ENC_ASM_H
#define vpp_AudioSbc_ENC_ASM_H

#include "cs_types.h"

#define vpp_AudioSbc_ENC_CODE_SIZE       280*4
   
#define vpp_AudioSbc_ENC_CODE_ENTRY 0
#define vpp_AudioSbc_ENC_CRITICAL_SECTION_MIN 0
#define vpp_AudioSbc_ENC_CRITICAL_SECTION_MAX 0

//#define vpp_AudioSbc_ENC_STREAM_BUF_STRUCT (   0 + 0x0)
#define vpp_AudioSbc_ENC_IN_STRUCT           (0   + 0x4000) 
#define vpp_AudioSbc_ENC_OUT_STRUCT        (20  + 0x4000)
...
#if 0
//common code
 static INT32 G_VppCommonDecCode[] = 
{
#include "audiojpeg_dec_common.tab"
};

//SBC ENCODER
static  INT32 G_VppSBCCode[] = 
{
#include "sbcenc.tab"
};

 static INT32 G_VppSBCConstX[] = 
{
...
//static INT8* G_Mp3NonCliPLBuf_alloc= NULL;
//INT8* G_Mp3NonCliPRBuf_alloc= NULL;
//static INT32* G_Mp3NonCliPLBuf= NULL;
