...
#if !defined(_CALIB_M_H_) && !defined(_TGT_CALIB_M_H_)
#define _CALIB_M_H_
...
/// Number of UINT32.
//#ifdef CHIP_HAS_AP
#define CALIB_AUDIO_RESERVE_QTY                  (64)
//#else
//#if defined(VOLUME_WITH_15_LEVEL) || defined(VOLUME_WITH_7_LEVEL) 
//#define CALIB_AUDIO_RESERVE_QTY                  (46)
//#else
//#define CALIB_AUDIO_RESERVE_QTY                  (64)
//#endif
//#endif
...
} CALIB_AUDIO_VOC_DigGain_T; //Size : 0x00000004
...
} CALIB_AUDIO_IIR_HPF_T; //Size : 0x00000014
...
} CALIB_AUDIO_VOC_AEC_T; //Size : 0x00000068
...
typedef struct
{
    INT16 flag;                                                 //0x00000000
    INT16 reserved;                                        //0x00000002
    INT16 gains[CALIB_VOC_MP3_QTY];                                       //0x00000004
} CALIB_AUDIO_VOC_MP3_FILTERS_T; //Size : 0x00000084
...
} CALIB_AUDIO_IIR_EQ_T; //Size : 0x00000a4
...
typedef struct
{
    CALIB_AUDIO_VOC_DigGain_T       gain;
    CALIB_AUDIO_IIR_HPF_T                     hpf;  //0x12
    CALIB_AUDIO_VOC_AEC_T              aec;  //0x64
    CALIB_AUDIO_VOC_SPEEX_T            speex;//0x20
    CALIB_AUDIO_VOC_AGC_T              agc;   //0x10
    CALIB_AUDIO_VOC_FILTERS_T       fir;     //0x100
    CALIB_AUDIO_IIR_EQ_T                    eq;    //0xa2
    // featurephone only
    CALIB_AUDIO_VOC_MP3_FILTERS_T   mp3;  //0x40
} CALIB_AUD_VOC_ITF_T; // Size : 0x00000288


typedef struct
{
    CALIB_AUD_VOC_ITF_T         voc[CALIB_AUDIO_ITF_QTY];
}CALIB_AUD_VOC_T;//0x11a0
#endif
...
typedef struct
{
   //second calib data[expand] from 0x3fa000
    ...
    CALIB_AUD_MUSIC_T            audio_music;      //0x00011A4
    UINT32 Rf_Reserved[613]; //   //0x0000166C  for 4 band calib rf
    #endif//Size : 0x2000
...
} CALIB_BUFFER_T; //Size : 0x1CFC-->0x00001D24
#endif
...
typedef struct
{
 ...
 //   VOLATILE CALIB_AUD_VOC_T       *hstaudio_voc;                //0x00001CFC
 //   VOLATILE CALIB_AUD_MUSIC_T     *hstaudio_music;              //0x00002A84
    #endif
