...
{
#if (CHIP_ASIC_ID == CHIP_ASIC_ID_5856 || CHIP_ASIC_ID == CHIP_ASIC_ID_5856E) // 5856 only support ep;
    return 1;
#endif
...
PUBLIC UINT32 gpio_detect_tcard(VOID)
{
    ...
    if(g_gpio_config->cardDetectGpio == HAL_GPIO_NONE)
        ...
        hal_GpioSetPinMux(g_gpio_config->cardDetectGpio, HAL_GPIO_ALTFUNC_CFG_1);
        hal_GpioSetIn(g_gpio_config->cardDetectGpio);
