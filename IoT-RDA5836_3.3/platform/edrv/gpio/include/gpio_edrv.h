...
PUBLIC VOID gpio_MutePinInit(void);
PUBLIC VOID gpio_LineinDetectIrqInit(void);
PUBLIC VOID gpio_LineinDetectDelay(VOID* param);
PUBLIC UINT8 gpio_CardDetectPowerOn(VOID);
PUBLIC VOID gpio_config(VOID);
PUBLIC VOID gpio_KeyLedMode(void);
PUBLIC BOOL gpio_detect_usb(void);
