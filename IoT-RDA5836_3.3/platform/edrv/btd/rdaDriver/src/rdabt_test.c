...
const uint32 rdabt_enable_spi_2_21[][2] =
{
{0x01A12000,0x0004F398},//enable spi2
...
const uint32 rdabt_vco_test_r21[][2] = 
{
{0xa1600020,0x00000043},
{0xa16082fc,0x00000000},//page 0
{0xa1608238,0x00000930},//0e
{0xa160827c,0x000003ff},//1f
{0xa1608280,0x000003ff},//20
{0xa1608208,0x0000f000},//00
};
...
void Rdabt_vco_test_Write_r21(void)
{
   uint16 i;
   RDA_WRITE_REG(rdabt_enable_spi_2_21[0][0],rdabt_enable_spi_2_21[0][1]);   
   RDA_WRITE_REG(rdabt_vco_test_r16[0][0],rdabt_vco_test_r16[0][1]); 
   
   for(i=1;i<sizeof(rdabt_vco_test_r16)/sizeof(rdabt_vco_test_r16[0]);i++)
   {
      RDA_WRITE_REG(rdabt_vco_test_r16[i][0],rdabt_vco_test_r16[i][1]);
   }   
}
...
{
      uint16 num_send;	
      rdabt_uart_tx(BT_UART_PORT,rdabt_rf_singlehop,sizeof(rdabt_rf_singlehop),&num_send);
      RDABT_DELAY(1);
      rdabt_uart_tx(BT_UART_PORT,rdabt_rf_inquiry,sizeof(rdabt_rf_inquiry),&num_send);
      RDABT_DELAY(1);	  
}
...
{
      uint16 num_send;
      rdabt_uart_tx(BT_UART_PORT,rdabt_enable_allscan,sizeof(rdabt_enable_allscan),&num_send);
      RDABT_DELAY(5);
      rdabt_uart_tx(BT_UART_PORT,rdabt_autoaccept_connect,sizeof(rdabt_autoaccept_connect),&num_send);
      RDABT_DELAY(5);	  	  
      rdabt_uart_tx(BT_UART_PORT,rdabt_enable_dut,sizeof(rdabt_enable_dut),&num_send);
      RDABT_DELAY(5);
}
...
{    
	uint16 num_send;
  	rdabt_uart_tx(BT_UART_PORT,rdabt_init_cmd,sizeof(rdabt_init_cmd),&num_send);
	RDABT_DELAY(5);
}
void RdaBt_Stop_cmd(void) 
{
	...
	uint8 stop_test_cmd[]={0x01,0x12,0xFD,0x00,}; //stop test
 	...
 	rdabt_uart_tx(BT_UART_PORT,stop_test_cmd,sizeof(stop_test_cmd),&num_send);
	RDABT_DELAY(5);
}
...
void RdaBtTest_send_manual_tx_cmd_r17(UINT32 type,UINT32 package,UINT32 freq,UINT32 pwrLevel,UINT32 msgPattern)
{
	...
	switch(type)
	{
		case CmdGFSK:
			...
			rdabt_uart_tx(BT_UART_PORT,uart_buff,sizeof(rdabt_DHn_test_r17),&num_send);
			RDABT_DELAY(5);
		...
		case Cmd4DQPSK:
			...
			rdabt_uart_tx(BT_UART_PORT,uart_buff,sizeof(rdabt_2DHn_test_r17),&num_send);
			RDABT_DELAY(5);
		...
		case Cmd8DPSK:
			...
			rdabt_uart_tx(BT_UART_PORT,uart_buff,sizeof(rdabt_3DHn_test_r17),&num_send);
			RDABT_DELAY(5);
...
void RdaBtTest_send_manual_tx_cmd_r18(UINT32 type,UINT32 package,UINT32 freq,UINT32 pwrLevel,UINT32 msgPattern)
{
	...
	switch(type)
	{
		case CmdGFSK:
			...
			rdabt_uart_tx(BT_UART_PORT,(uint8 *)&t_bt_test_burst_tmp,sizeof(bt_test_burst),&num_send);
			RDABT_DELAY(5);
...
void RdaBtTest_send_manual_tx_cmd(UINT32 type,UINT32 package,UINT32 freq,UINT32 pwrLevel)
{
	...
	if((0 == type)&&(0 == package))
	{
		...
		rdabt_uart_tx(BT_UART_PORT,rdabt_DH1_test,sizeof(rdabt_DH1_test),&num_send);
      	RDABT_DELAY(5);
	}
	else if((0 == type)&&(1 == package))
	{
		...
		rdabt_uart_tx(BT_UART_PORT,rdabt_DH3_test,sizeof(rdabt_DH3_test),&num_send);
      	RDABT_DELAY(5);
	}
	else if((0 == type)&&(2 == package))
	{
		...
		rdabt_uart_tx(BT_UART_PORT,rdabt_DH5_test,sizeof(rdabt_DH5_test),&num_send);
      	RDABT_DELAY(5);
	}
	else if((1 == type)&&(0 == package))
	{
		...
		rdabt_uart_tx(BT_UART_PORT,rdabt_2DH1_test,sizeof(rdabt_2DH1_test),&num_send);
      	RDABT_DELAY(5);
	}
	else if((1 == type)&&(1 == package))
	{
		...
		rdabt_uart_tx(BT_UART_PORT,rdabt_2DH3_test,sizeof(rdabt_2DH3_test),&num_send);
      	RDABT_DELAY(5);
	}
	else if((1 == type)&&(2 == package))
	{
		...
		rdabt_uart_tx(BT_UART_PORT,rdabt_2DH5_test,sizeof(rdabt_2DH5_test),&num_send);
      	RDABT_DELAY(5);
	}
	else if((2 == type)&&(0 == package))
	{
		...
		rdabt_uart_tx(BT_UART_PORT,rdabt_3DH1_test,sizeof(rdabt_3DH1_test),&num_send);
      	RDABT_DELAY(5);
	}
	else if((2 == type)&&(1 == package))
	{
		...
		rdabt_uart_tx(BT_UART_PORT,rdabt_3DH3_test,sizeof(rdabt_3DH3_test),&num_send);
      	RDABT_DELAY(5);
	}
	else if((2 == type)&&(2 == package))
	{
		...
		rdabt_uart_tx(BT_UART_PORT,rdabt_3DH5_test,sizeof(rdabt_3DH5_test),&num_send);
      	RDABT_DELAY(5);
	}
}
*/
