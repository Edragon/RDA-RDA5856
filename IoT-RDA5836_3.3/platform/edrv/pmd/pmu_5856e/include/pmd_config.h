...
typedef enum
{
    ...
    PMD_LDO_IO1P8   = (PMD_LDO_ID_TYPE_OPAL << 16) | (1<<8),
    PMD_LDO_ASW     = (PMD_LDO_ID_TYPE_OPAL << 16) | (1<<9),
    PMD_LDO_ABB     = (PMD_LDO_ID_TYPE_OPAL << 16) | (1<<10),
    PMD_LDO_VIO2P8  = (PMD_LDO_ID_TYPE_OPAL << 16) | (1<<11),
...
// =============================================================================
// PMD_KEY_POWERON_INTERVAL
// -----------------------------------------------------------------------------
/// Used to set interval for key power on
// =============================================================================
typedef enum
{   
    //250ms
    PMD_KEY_POWERON_INTERVAL0,
    //500ms
    PMD_KEY_POWERON_INTERVAL1,
    //1s
    PMD_KEY_POWERON_INTERVAL2,
    //2s
    PMD_KEY_POWERON_INTERVAL3
}PMD_KEY_POWERON_INTERVAL_T;
...
struct PMD_CONFIG_STRUCT_T
{
    ...
    // interval for key power on
    UINT8 keyPowerOnInterval;
