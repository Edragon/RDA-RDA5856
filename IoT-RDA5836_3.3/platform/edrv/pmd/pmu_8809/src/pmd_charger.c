...
#if 0
        hal_HstSendEvent(SYS_EVENT, 0x14041101);
        UINT16 value = pmd_GetRawEffuseValue(PMD_EFFUSE_PAGE_VBAT_4P2);//page 2
        hal_HstSendEvent(SYS_EVENT,  (value&(0x1f<<10))>>10);
        value = pmd_GetRawEffuseValue(PMD_EFFUSE_PAGE_VBAT_3P4);//page 1
        hal_HstSendEvent(SYS_EVENT,  (value&(0x1f<<10))>>10);
        value = pmd_GetRawEffuseValue(PMD_EFFUSE_PAGE_CHARGER);//page 0
        hal_HstSendEvent(SYS_EVENT, (value&(0xf<<10))>>10);	

        hal_HstSendEvent(SYS_EVENT, 0x14051101);
        UINT16 value = pmd_GetRawEffuseValue(PMD_EFFUSE_PAGE_VBAT_4P2);//page 2
