...
/// one of them.
// =============================================================================
typedef AUD_ERR_T (*AUD_STREAM_INIT_T) (VOID);
...
// =============================================================================
PUBLIC AUD_ERR_T aud_LineinRecordSetup(CONST SND_ITF_T         itf,
                                   CONST HAL_AIF_STREAM_T* stream,
                                   CONST AUD_LEVEL_T *     cfg,
                                   AUD_TEST_T              mode);
...
PUBLIC BOOL aud_LineinRegisterMallocFreeFunc(AUD_TEST_MODE_MALLOC_FUNC_T mallocFunc,
