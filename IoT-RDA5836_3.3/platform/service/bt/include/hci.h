...
#if 1
//RDA_PCT_DBG
#define HCI_cmdREADINQUIRYANDPAGESCANTESTMODE               ((0x3<<10)|0x6E)
#define HCI_cmdWRITEINQUIRYANDPAGESCANTESTMODE               ((0x3<<10)|0x6F)
#endif
...
#define HCI_BASEBAND_RXTEST				 ((0x3f<<10) |0x113)
#define HCI_DISCARD_SBC					 ((0x3f<<10) |0x116)
#define HCI_CALIB_CLOCK			         ((0x3f<<10) |0x177)

#define HCI_SET_LOCAL_KEY                ((0x3f<<10) |0x220)
#define HCI_SET_PEER_KEY                 ((0x3f<<10) |0x221)
#define HCI_READ_RAW_RSSI                ((0x3f<<10)+0x0061)

//hci externsion command for Spreadtrum marlin bt
...
//5.0 new added
#define HCI_cmdLEREADPHY										((0x08<<10) |0x30)
#define HCI_cmdLESETDEFAULTPHY								((0x08<<10) |0x31)
#define HCI_cmdLESETPHY										((0x08<<10) |0x32)
#define HCI_cmdLEENHANCEDRECEIVERTEST						((0x08<<10) |0x33)
#define HCI_cmdLEENHANCEDTRANSMITTERTEST					((0x08<<10) |0x34)
#define HCI_cmdLESETADVERTISINGSETRANDOMADDRESS			((0x08<<10) |0x35)
#define HCI_cmdLESETEXTENDEDADVERTISINGPARAMETERS			((0x08<<10) |0x36)
#define HCI_cmdLESETEXTENDEDADVERTISINGDATA					((0x08<<10) |0x37)
#define HCI_cmdLESETEXTENDEDSCANRESPONSEDATA				((0x08<<10) |0x38)
#define HCI_cmdLESETEXTENDEDADVERTISINGENABLE				((0x08<<10) |0x39)
#define HCI_cmdLEREADMAXIMUMADVERTISINGDATALENGTH			((0x08<<10) |0x3A)
#define HCI_cmdLEREADNUMBEROFSUPPORTEDADVERTISINGSETS		((0x08<<10) |0x3B)
#define HCI_cmdLEREMOVEADVERTISINGSET						((0x08<<10) |0x3C)
#define HCI_cmdLECLEARADVERTISINGSETS						((0x08<<10) |0x3D)
#define HCI_cmdLESETPERIODICADVERTISINGPARAMETERS			((0x08<<10) |0x3E)
#define HCI_cmdLESETPERIODICADVERTISINGDATA					((0x08<<10) |0x3F)
#define HCI_cmdLESETPERIODICADVERTISINGENABLE				((0x08<<10) |0x40)
#define HCI_cmdLESETEXTENDEDSCANPARAMETERS					((0x08<<10) |0x41)
#define HCI_cmdLESETEXTENDEDSCANENABLE						((0x08<<10) |0x42)
#define HCI_cmdLEEXTENDEDCREATECONNECTION					((0x08<<10) |0x43)
#define HCI_cmdLEPERIODICADVERTISINGCREATESYNC				((0x08<<10) |0x44)
#define HCI_cmdLEPERIODICADVERTISINGCREATESYNCCANCEL		((0x08<<10) |0x45)
#define HCI_cmdLEPERIODICADVERTISINGTERMINATESYNC			((0x08<<10) |0x46)
#define HCI_cmdLEADDDEVICETOPERIODICADVERTISERLIST			((0x08<<10) |0x47)
#define HCI_cmdLEREMOVEDEVICEFROMPERIODICADVERTISERLIST	((0x08<<10) |0x48)
#define HCI_cmdLECLEARPERIODICADVERTISERLIST					((0x08<<10) |0x49)
#define HCI_cmdLEREADPERIODICADVERTISERLISTSIZE				((0x08<<10) |0x4A)
#define HCI_cmdLEREADTRANSMITPOWER							((0x08<<10) |0x4B)
#define HCI_cmdLEREADRFPATHCOMPENSATION						((0x08<<10) |0x4C)
#define HCI_cmdLEWRITERFPATHCOMPENSATION					((0x08<<10) |0x4D)
#define HCI_cmdLESETPRIVACYMODE								((0x08<<10) |0x4E)
...
#define HCI_evMARLINWRITEPSKEY						0x6F
...
typedef struct st_hci_sco_data_t{
    u_int16 handle;
    u_int8 length;
    u_int8 flag;
    u_int16 *data;
...
#if 1
//RDA_PCT_DBG
APIDECL1 t_api APIDECL2 HCI_ReadInquiryAndPageScanTestActivity(struct st_t_dataBuf **cmd);
APIDECL1 t_api APIDECL2 HCI_WriteInquiryAndPageScanTestActivity(struct st_t_dataBuf **cmd, u_int16 interval,u_int16 window);
#endif
...
APIDECL1 t_api APIDECL2 HCI_BaseBand_TXTest(struct st_t_dataBuf **cmd,  u_int8 hop_frq, 
						u_int8 msg_type, u_int8 power_level,
						...
						u_int8 crc_init, u_int8 is_whiten, u_int8 whiten_init);
//APIDECL1 t_api APIDECL2 HCI_BaseBand_RXTest(struct st_t_dataBuf **cmd);
APIDECL1 t_api APIDECL2 HCI_BaseBand_RXTest(struct st_t_dataBuf **cmd,u_int8 hop_frq, 
														u_int8 EDR_mode,u_int8 pattern,
														u_int8 is_whiten,u_int8 whiten_init,
														u_int8 am_addr,u_int32 total_packet);
APIDECL1 t_api APIDECL2 HCI_BaseBand_TestEnd(struct st_t_dataBuf **cmd);
APIDECL1 t_api APIDECL2 HCI_Discard_Sbc(struct st_t_dataBuf **cmd,u_int8 on_off,u_int16 cid);
...
APIDECL1 t_api APIDECL2 HCI_Read_Raw_Rssi(struct st_t_dataBuf **cmd,u_int16 handle);
...
#if defined(BLUETOOTH_USE_MARLIN) && BLUETOOTH_USE_MARLIN==1
///spreadtrum marlin Bt extention command
typedef struct st_t_marlin_pskey {
    u_int8 dbg_source_sink_syn_test_data;       //default value:0, BQB audio test flag
    u_int8 sys_sleep_in_standby_supported;     //default value:1, Sleep supported flag in standby mode
    u_int8  sys_sleep_in_master_supported;     //default value: 1: Sleep supported flag in master role
    u_int8 sys_sleep_slave_supported;              //default value: 1; Sleep supported flag in slave role
    u_int32 default_ahb_clk;                               //default value: 26000000 AHB default clock
    u_int32 device_class;                                    //default value: 0x001F00 Device class
    u_int32 win_ext;                                             //default value: 30 Receive window
    u_int32 aGainValue[6];                                      //default value:  {0x0000F600, 0x0000D000, 0x0000AA00, 0x00008400, 0x00004400, 0x00000A00}, Receive gain
    u_int32 aPowerValue[5];                                   //default value: {0x0FC80000, 0x0FF80000, 0x0FDA0000, 0x0FCC0000, 0x0FFC0000},Transmit gain
    u_int8 feature_set[16];                                       //default value: {0xFF, 0xFF, 0x8D, 0xFE, 0x9B, 0x7F, 0x79, 0x83, 0xFF, 0xA7, 0xFF, 0x7F, 0x00, 0xE0, 0xF7, 0x3E}, feature
    u_int8 device_addr[6];                                        //default value: {0x6A, 0x6B, 0x8C, 0x8A, 0x8B, 0x8C}, bluetooth address
    u_int8 sys_sco_transmit_mode;                         //default value:  0, //true tramsmit by uart, otherwise by share memory
    u_int8 sys_uart0_communication_supported;   //default value:  1, //true use uart0, otherwise use uart1 for debug
    u_int8 edr_tx_edr_delay;                                   //default value: 5  EDR Tx delay
    u_int8 edr_rx_edr_delay;                                   //default value: 14  EDR Rx delay
    u_int16 wbs_nv_117;                                           //default value: 0x007C Wide ban speech register
    u_int32 is_wdg_supported;                                 //default value: 0 Watch dog supported flag
    u_int32 share_memo_rx_base_addr;                 //default value: 0 Share memory base address
    u_int16 wbs_nv_118;                                           //default value: 0x0066 Wide ban speech register
    u_int16 nbv_nv_117;                                           //default value: 0x10F9 Narrow ban speech register
    u_int32 share_memo_tx_packet_num_addr;      //default value: 1 Firmware Log port:0:Disable 1:USB Log ,2:UART Log
    u_int32 share_memo_tx_data_base_addr;         //default value: 0, 
    u_int32 PrintLevel;                                                //default value: 0xFFFFFFFF Log Level
    u_int16 share_memo_tx_block_length;               //default value: 0 AGC flage 0:HW 1:SW
    u_int16 share_memo_rx_block_length;               //default value: 0 Uart receive block length
    u_int16 share_memo_tx_water_mark;                //default value: 0 LE transmit power
    u_int16 nbv_nv_118;                                             //default value: 0 LE transmit power
    u_int16 uart_rx_watermark;                               //default value: 48 Uart receive threshold
    u_int16 uart_flow_control_thld;                           //default value: 64 Uart flow controler threshold
    u_int32 comp_id;                                                  //default value: 0x01EC Company id
    u_int16 pcm_clk_divd;                                         //default value: 0x26 PCMclock
    u_int32 reserved[21];                                                //default value: {0}
    } t_MarlinPskey;

APIDECL1 t_api APIDECL2 HCI_Write_Marlin_Pskey(struct st_t_dataBuf **cmd, t_MarlinPskey  *pskey);
APIDECL1 t_api APIDECL2 HCI_Write_Marlin_Module_Enable(struct st_t_dataBuf **cmd,u_int16 type, u_int8 state);
APIDECL1 t_api APIDECL2 HCI_Write_Marlin_ACL_Priority(struct st_t_dataBuf **cmd, u_int16 handle, u_int8  priority);
#endif

//Add for LE5.0
APIDECL1 t_api APIDECL2  HCI_LEReadPhy(struct st_t_dataBuf **cmd, u_int16 Connection_Handle);

APIDECL1 t_api APIDECL2  HCI_LESetDefaultPhy(struct st_t_dataBuf **cmd, u_int8 all_pyhs, u_int8 tx_pyhs, u_int8 rx_phys);
APIDECL1 t_api APIDECL2  HCI_LESetPhy(struct st_t_dataBuf **cmd, u_int16 Connection_Handle, u_int8 all_pyhs, u_int8 tx_pyhs, u_int8 rx_phys, u_int16 phy_options);
APIDECL1 t_api APIDECL2  HCI_LEEnhancedReceiverTest(struct st_t_dataBuf **cmd, u_int8 rx_channel, u_int8 phy, u_int8 modulation_index);
APIDECL1 t_api APIDECL2  HCI_LEEnhancedTransmitterTest(struct st_t_dataBuf **cmd, u_int8 tx_channel, u_int8 length_of_test_data, u_int8 packet_payload, u_int8 phy);
APIDECL1 t_api APIDECL2  HCI_LESetAdvertisingSetRandomAddress(struct st_t_dataBuf **cmd, u_int8 Advertising_Handle, t_bdaddr random_addr);
APIDECL1 t_api APIDECL2  HCI_LESetExtendedAdvertisingParameters(struct st_t_dataBuf **cmd, u_int8 adv_handle, u_int16 adv_evt_properties, u_int32 pri_adv_interval_min,  u_int32 pri_adv_interval_max,
									u_int8 pri_adv_ch_map, u_int8 own_addr_type, u_int8 peer_addr_type, t_bdaddr peer_addr, u_int8 adv_filter_policy, u_int8 adv_tx_power, u_int8 pri_adv_phy, 
									u_int8 secondary_adv_max_skip, u_int8 secondary_adv_hy, u_int8 adv_sid, u_int8 scan_req_notification_enable);
APIDECL1 t_api APIDECL2 HCI_LESetExtendedAdvertisingData(struct st_t_dataBuf **cmd, u_int8 AdvHandle,  u_int8 operation, u_int8 fragment_preference, u_int8 adv_data_len, u_int8* adv_data);
APIDECL1 t_api APIDECL2 HCI_LESetExtendedScanResponseData(struct st_t_dataBuf **cmd, u_int8 AdvHandle,  u_int8 operation, u_int8 fragment_preference, u_int8 scan_resp_data_len, u_int8* scan_resp_data);
APIDECL1 t_api APIDECL2 HCI_LESetExtendedAdvertisingEnable(struct st_t_dataBuf **cmd, u_int8 enable,  u_int8 num_of_sets, u_int8 *adv_handle, u_int16 *duration, u_int8 *max_ext_adv_evt);
APIDECL1 t_api APIDECL2  HCI_LEReadMaximumAdvertisingDataLength(struct st_t_dataBuf **cmd);
APIDECL1 t_api APIDECL2  HCI_LEReadNumberOfSupportedAdvertisingSets(struct st_t_dataBuf **cmd);
APIDECL1 t_api APIDECL2  HCI_LERemoveAdvertisingSet(struct st_t_dataBuf **cmd, u_int8 adv_handle);
APIDECL1 t_api APIDECL2  HCI_LEClearAdvertisingSets(struct st_t_dataBuf **cmd);
APIDECL1 t_api APIDECL2  HCI_LESetPeriodicAdvertisingParameters(struct st_t_dataBuf **cmd, u_int8 adv_handle, u_int16 periodic_adv_interval_min,
																u_int16 periodic_adv_interval_max, u_int16 periodic_adv_properties);
APIDECL1 t_api APIDECL2 HCI_LESetPeriodicAdvertisingData(struct st_t_dataBuf **cmd, u_int8 AdvHandle,  u_int8 operation, u_int8 adv_data_len, u_int8* adv_data);
APIDECL1 t_api APIDECL2  HCI_LESetPeriodicAdvertisingEnable(struct st_t_dataBuf **cmd, u_int8 enable, u_int8 adv_handle);
APIDECL1 t_api APIDECL2 HCI_LESetExtendedScanParameters(struct st_t_dataBuf **cmd, u_int8 own_addr_type,  u_int8 scan_filter_policy, u_int8 scan_phys, u_int8 *scan_type, u_int16 *scan_interval, u_int16 *scan_window);
APIDECL1 t_api APIDECL2  HCI_LESetExtendedScanEnable(struct st_t_dataBuf **cmd, u_int8 enable, u_int8 filter_duplicates, u_int16 duration, u_int16 period);
APIDECL1 t_api APIDECL2  HCI_LEExtendedCreateConnection(struct st_t_dataBuf **cmd, u_int8 init_filter_policy, u_int8 own_addr_type, u_int8 peer_addr_type, t_bdaddr peer_addr,
						u_int8 init_phys, u_int16 *scan_interval, u_int16 *scan_window, u_int16 *conn_interval_min, u_int16 *conn_interval_max, u_int16 *conn_latency,
						u_int16 *supervision_timeout, u_int16 *minimum_ce_len, u_int16 *maximum_ce_len);
APIDECL1 t_api APIDECL2  HCI_LEPeriodicAdvertisingCreateSync(struct st_t_dataBuf **cmd, u_int8 filter_policy, u_int8 adv_sid, u_int8 adv_addr_type, t_bdaddr adv_addr, u_int16 skip, u_int16 sync_timeout, u_int8 unused);
APIDECL1 t_api APIDECL2  HCI_LEPeriodicAdvertisingCreateSyncCancel(struct st_t_dataBuf **cmd);
APIDECL1 t_api APIDECL2  HCI_LEPeriodicAdvertisingTerminateSync(struct st_t_dataBuf **cmd, u_int16 sync_handle);
APIDECL1 t_api APIDECL2  HCI_LEAddDeviceToPeriodicAdvertiserList(struct st_t_dataBuf **cmd, u_int8 adv_addr_type, t_bdaddr adv_addr, u_int8 adv_sid);
APIDECL1 t_api APIDECL2  HCI_LERemoveDeviceFromPeriodicAdvertiserList(struct st_t_dataBuf **cmd, u_int8 adv_addr_type, t_bdaddr adv_addr, u_int8 adv_sid);
APIDECL1 t_api APIDECL2  HCI_LEClearPeriodicAdvertiserList(struct st_t_dataBuf **cmd);
APIDECL1 t_api APIDECL2  HCI_LEReadPeriodicAdvertiserListSize(struct st_t_dataBuf **cmd);
APIDECL1 t_api APIDECL2  HCI_LEReadTransmitPower(struct st_t_dataBuf **cmd);
APIDECL1 t_api APIDECL2  HCI_LEReadRfPathCompensation(struct st_t_dataBuf **cmd);
APIDECL1 t_api APIDECL2  HCI_LEWriteRfPathCompensation(struct st_t_dataBuf **cmd, u_int16 tx_value, u_int16 rx_value);
APIDECL1 t_api APIDECL2  HCI_LESetPrivacyMode(struct st_t_dataBuf **cmd, u_int8 peer_identity_addr_type, u_int8 *peer_identity_addr, u_int8 privacy_mode);
