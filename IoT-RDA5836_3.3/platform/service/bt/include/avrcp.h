...
APIDECL1 t_api APIDECL2 Avrcp_Send_Press(u_int8 key, t_bdaddr addr);
APIDECL1 t_api APIDECL2 Avrcp_Send_Release(u_int8 key, t_bdaddr addr);
APIDECL1 t_api APIDECL2 Avrcp_Update_Player_Status(t_bdaddr addr);
APIDECL1 t_api APIDECL2 Avrcp_Get_Element_Attribute(t_bdaddr addr);
...
APIDECL1 t_api APIDECL2 Avrcp_Set_Absolute_Volume(u_int16 cid, u_int8 volume);
APIDECL1 t_api APIDECL2 Avrcp_Get_Capabilities(u_int8 capability_id, t_bdaddr addr);
APIDECL1 t_api APIDECL2 Avrcp_Set_Browsing_command(u_int8 pdu_id, u_int16 data_len, u_int8* data , u_int16 cid);
APIDECL1 t_api APIDECL2 Avrcp_Get_Player_Status(t_bdaddr addr);
void Avrcp_Set_Notification(u_int8 event_id, t_bdaddr addr);
APIDECL1 t_api APIDECL2 Avrcp_List_Player_Application_Setting_Attributes(t_bdaddr addr);
APIDECL1 t_api APIDECL2 Avrcp_List_Player_Application_Setting_Values(u_int8 attribute_id, t_bdaddr addr);
APIDECL1 t_api APIDECL2 Avrcp_Get_Current_Player_Application_Setting_Values(u_int8 number, u_int8 *attribute_id, t_bdaddr addr);
APIDECL1 t_api APIDECL2 Avrcp_Set_Player_Application_Setting_Values(u_int8 number, u_int8 *attribute, t_bdaddr addr);
APIDECL1 t_api APIDECL2 Avrcp_Get_Player_Application_Setting_Attributes_Text(u_int8 number, u_int8 *attribute_id, t_bdaddr addr);
APIDECL1 t_api APIDECL2 Avrcp_Get_Player_Application_Setting_Values_Text(u_int8 number, u_int8 attribute_id, u_int8 *value_id, t_bdaddr addr);
APIDECL1 t_api APIDECL2 Avrcp_Inform_Displayable_Character_Set(u_int8 number, u_int16 *charset_id, t_bdaddr addr);
APIDECL1 t_api APIDECL2 Avrcp_Inform_Battery_Status_of_CT(u_int8 status, t_bdaddr addr);
