...
typedef struct _bt_mgr_config {
    ...
    */
    ...
    u_int8 auto_repair_support;
    u_int8 default_le_mode;
    u_int8 support_soundbar;
    u_int8 support_switch_role;
    u_int8 support_all_event_report;
} manager_config_t;
