...
typedef struct st_t_BT_DeviceEntry 
{
	/* WARNING - this structure MUST match the layout of the first part of the st_t_BT_DeviceInfo structure above */
        ...
        s_int8 rssi;
        u_int8 name_length;
        u_int8 name[MAX_BT_DEVICE_NAME];
...
APIDECL1 t_api APIDECL2 MGR_WriteLocalDeviceCOD(u_int32 local_cod);
...
APIDECL1 t_api APIDECL2 MGR_BaseBand_TXTest( u_int8 hop_frq, u_int8 msg_type, u_int8 power_level,
											u_int8 tx_packet_type, u_int8 EDR_mode, u_int32 tx_len,
											u_int8 am_addr, u_int32 syncword_low, u_int32 syncword_hight , u_int8 hop_en,
