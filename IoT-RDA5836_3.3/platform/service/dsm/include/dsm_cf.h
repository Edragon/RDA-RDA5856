...
#define DSM_MAlloc pMalloc
#define DSM_Free pFree
#else
#define DSM_MAlloc(obj)                     COS_Malloc_BTOverlay(obj) //CSW_MALLOC(BASE_DSM_TS_ID, (obj))
#define DSM_Free(obj)                       COS_Free_BTOverlay((PSTR)obj) //CSW_FREE(BASE_DSM_TS_ID, (PSTR)(obj))
#endif
...
extern BOOL COS_SleepByTick( UINT32 );
...
#define DSM_Sleep(obj) COS_SleepByTick(obj)
