...
typedef struct fs_lod_header
{
    ...
    //UINT32 ram_phy_size; 
    UINT32 calib_base; 
    UINT32 fact_setting_base; 
    //UINT32 code_base;
    UINT32 user_data_base; 
...
INT32 SRVAPI FS_Rename_Latters_Switch(
    PCSTR pszOldname,
    PCSTR pszNewname
);
...
INT32 SRVAPI	FS_LodGetNextPacket(
        INT32 fd,
        FS_LodPacket* packet
);

INT32 SRVAPI FS_LodGetUserLodPacket(
        INT32 fd,
        FS_LodPacket* packet
);
