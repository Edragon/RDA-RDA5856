...
#if defined(NUMBER_OF_SIM)
#if (NUMBER_OF_SIM != 1)
typedef enum
{
  CFW_SIM_0 = 0x00,
  CFW_SIM_1 = 0x01,
  CFW_SIM_COUNT = NUMBER_OF_SIM,
  CFW_SIM_END = 0xFF,
}CFW_SIM_ID;
#endif
#endif /* NUMBER_OF_SIM */
...
typedef UINT32
(*PFN_CFW_EV_PORC) (CFW_EVENT* pEvent, VOID* pUserData);
...
UINT32 SRVAPI
CFW_SetEventProc (UINT8 nServiceId, PVOID pUserData,
...
UINT32 SRVAPI
CFW_BalSetEventPorc (PVOID pUserData, PFN_CFW_EV_PORC pfnProc);

UINT32 SRVAPI
CFW_IsFreeUTI (UINT16 nUTI, UINT32 nServiceId);

UINT32 SRVAPI
CFW_GetFreeUTI (UINT32 nServiceId, UINT8* pUTI);

BOOL SRVAPI
CFW_BlockEvent (UINT32 event);

BOOL SRVAPI
CFW_UnBlockEvent (UINT32 event);

UINT32 SRVAPI
CFW_IsServiceAvailable (UINT32 nServiceId, UINT8* pAvailable);

UINT32 SRVAPI
CFW_SendReqEvent (UINT32 nEventId, UINT32 nParam1,
...
UINT32 SRVAPI
CFW_ShellControl (UINT8 nCommand);
...
UINT32 SRVAPI
CFW_CfgSetPhoneFunctionality (UINT8 nLevel, UINT8 nRst);

UINT32 SRVAPI
CFW_CfgGetPhoneFunctionality (UINT8* pLevel);

UINT32 SRVAPI
CFW_CfgStoreUserProfile (
VOID
);

UINT32 SRVAPI
CFW_CfgRestoreFactoryProfile (
VOID
);

UINT32 SRVAPI
CFW_CfgGetUserProfile (VOID);

#define CFW_CHSET_UCS2 0 
#define CFW_CHSET_GSM  1 

UINT32 SRVAPI
CFW_CfgGetCharacterSet (UINT8* chset);

UINT32 SRVAPI
CFW_CfgSetCharacterSet (UINT8 chset);
...
UINT32 SRVAPI
CFW_CfgSetIndicatorEvent (UINT16 ind);

UINT32 SRVAPI
CFW_CfgGetIndicatorEvent (UINT16* ind);

UINT32 SRVAPI
CFW_CfgSetIndicatorEventInfo (CFW_IND_EVENT_INFO* pIndInfo);

UINT32 SRVAPI
CFW_CfgGetIndicatorEventInfo (CFW_IND_EVENT_INFO* pIndInfo);
UINT32
CFW_SetQualReport (BOOL bStart);
#endif

UINT32
CFW_CfgSetFirstPowerOnFlag (BOOL bFPO);

UINT32
CFW_CfgCheckFirstPowerOnFlag (BOOL *pbFPO);

UINT32 SRVAPI
CFW_CfgGetEventReport (UINT16* pMer);

UINT32 SRVAPI
CFW_CfgSetEventReport (UINT16 pMer);

UINT32 SRVAPI
CFW_CfgSetResultCodePresentMode (UINT8 nMode);

UINT32 SRVAPI
CFW_CfgSetResultCodeFormatMode (UINT8 nMode);

UINT32 SRVAPI
CFW_CfgGetResultCodePresentMode (UINT8* pMode);

UINT32 SRVAPI
CFW_CfgGetResultCodeFormatMode (UINT8* pMode);

UINT32 SRVAPI
CFW_CfgGetProductIdentification (UINT8* pIdText);

UINT32 SRVAPI
CFW_CfgGetExtendedErrorV0 (PSTR* pErrReport);

UINT32 SRVAPI
CFW_CfgSetExtendedErrorV0 (UINT32 nErrorCode);

UINT32 SRVAPI
CFW_CfgSetEchoMode (UINT8 nMode);
UINT32 SRVAPI
CFW_CfgGetEchoMode (UINT8 *nMode);
...
UINT32 SRVAPI
CFW_CfgGetExtendedErrorV1 (CFW_EXTENDED_ERROR* pExtendedError);

UINT32 SRVAPI
CFW_CfgGetErrorReport (UINT8* pLevel);

UINT32 SRVAPI
CFW_CfgSetErrorReport (UINT8 nLevel);
...
UINT32 SRVAPI
CFW_CfgDeviceSwithOff (VOID);

UINT32 SRVAPI
CFW_CfgSetResultCodeFormatMode (UINT8 nMode);

UINT32 SRVAPI
CFW_CfgSetConnectResultFormatCode (UINT8 nValue);

UINT32 SRVAPI
CFW_CfgGetConnectResultFormatCode (UINT8 *nValue);

UINT32
CFW_CfgSetSoftReset (UINT8 cause);
UINT32
CFW_CfgGetSoftReset (UINT8 *cause);
UINT32
CFW_CfgSetResetCause (UINT8 cause);
UINT32
CFW_CfgGetResetCause (UINT8 *cause);
//SMS Configuration
...
UINT32 SRVAPI
CFW_CfgSetSmsStorageInfo (CFW_SMS_STORAGE_INFO* pStorageInfo, UINT16 nStorage);

UINT32 SRVAPI
CFW_CfgGetSmsStorageInfo (CFW_SMS_STORAGE_INFO* pStorageInfo, UINT16 nStorage);

UINT32 SRVAPI
CFW_CfgSetSmsStorage (UINT8 nStorage);

UINT32 SRVAPI
CFW_CfgGetSmsStorage (UINT8* pStorage);

UINT32 SRVAPI
CFW_CfgSetNewSmsOption (UINT8 nOption, UINT8 nNewSmsStorage);

UINT32 SRVAPI
CFW_CfgGetNewSmsOption (UINT8* pOption, UINT8* pNewSmsStorage);

UINT32 SRVAPI
CFW_CfgSetSmsOverflowInd (UINT8 nMode);

UINT32 SRVAPI
CFW_CfgGetSmsOverflowInd (UINT8* pMode);

UINT32 SRVAPI
CFW_CfgSetSmsFormat (UINT8 nFormat);

UINT32 SRVAPI
CFW_CfgGetSmsFormat (UINT8* nFormat);

UINT32 SRVAPI
CFW_CfgSetSmsShowTextModeParam (UINT8 nShow);

UINT32 SRVAPI
CFW_CfgGetSmsShowTextModeParam (UINT8* pShow);

UINT32 SRVAPI
CFW_CfgSetSmsParam (CFW_SMS_PARAMETER* pInfo, //modified by fengwei 20080707 for save sca to sim
    UINT16 nUTI);

UINT32 SRVAPI
CFW_CfgGetSmsParam (CFW_SMS_PARAMETER* pInfo, UINT8 nIndex);

#endif

UINT32 SRVAPI
CFW_CfgSelectSmsService (UINT8 nService, UINT8* pSupportedType);

UINT32 SRVAPI
CFW_CfgQuerySmsService (UINT8* pService);

UINT32 SRVAPI
CFW_CfgSetSmsCB (UINT8 mode, UINT8 mids[6], UINT8 dcss[6]);

UINT32 SRVAPI
CFW_CfgGetSmsCB (UINT8* pMode, UINT8 mids[6], UINT8 dcss[6]);
...
UINT32 SRVAPI
CFW_CfgGetPbkStrorageInfo (CFW_PBK_STRORAGE_INFO* pStorageInfo);

UINT32 SRVAPI
CFW_CfgSetPbkStrorageInfo (CFW_PBK_STRORAGE_INFO* pStorageInfo);
...
UINT32 SRVAPI
CFW_CfgSetPbkStorage (UINT8 nStorage);

UINT32 SRVAPI
CFW_CfgGetPbkStorage (UINT8* nStorage);

UINT32 SRVAPI
CFW_CfgNwSetFrequencyBand (UINT8 nBand);

UINT32 SRVAPI
CFW_CfgNwGetFrequencyBand (UINT8* pBand);
UINT32 SRVAPI
CFW_CfgNwGetNetWorkMode (UINT8 *pMode);

UINT32 SRVAPI
CFW_CfgNwSetNetWorkMode (UINT8 nMode);

UINT32 SRVAPI
CFW_CfgGetNwStatus (UINT8* pCmd);

UINT32 SRVAPI
CFW_CfgSetNwStatus (UINT8 n);

#endif

UINT32 SRVAPI
CFW_CfgNwGetOperatorInfo (UINT8** pOperatorId, UINT8** pOperatorName,
			  UINT8 nIndex);

UINT32 SRVAPI
CFW_CfgGetNwOperDispFormat (UINT8* nFormat);

UINT32 SRVAPI
CFW_CfgNwGetOperatorId (UINT8** pOperatorId, UINT8* pOperatorName);

UINT32 SRVAPI
CFW_CfgNwGetOperatorName (UINT8 pOperatorId[6], UINT8** pOperatorName);

UINT32 SRVAPI
CFW_CfgSetNwOperDispFormat (UINT8 nFormat);
...
UINT32 SRVAPI
CFW_CfgSetSSN (UINT8 nCSSI, UINT8 nCSSU);

UINT32 SRVAPI
CFW_CfgGetSSN (UINT8* pCSSI, UINT8* pCSSU);

UINT32 SRVAPI
CFW_CfgSetClir (UINT8 nClir);

UINT32 SRVAPI
CFW_CfgGetClir (UINT8* n);

UINT32 SRVAPI
CFW_CfgSetClip (UINT8 nEnable);

UINT32 SRVAPI
CFW_CfgGetClip (UINT8* n);

UINT32 SRVAPI
CFW_CfgSetColp (UINT8 n);

UINT32 SRVAPI
CFW_CfgGetColp (UINT8* n);

UINT32 SRVAPI
CFW_CfgSetCallWaiting (UINT8 n);

UINT32 SRVAPI
CFW_CfgGetCallWaiting (UINT8* n);
UINT32
CFW_CfgGetIMSI (UINT8 * pIMSI);

UINT32
CFW_CfgSetIMSI (UINT8 * pIMSI);

#endif

UINT32 SRVAPI
CFW_CfgSetToneDuration (UINT8 nToneDuration);

UINT32 SRVAPI
CFW_CfgGetToneDuration (UINT8* pToneDuration);

UINT32
CFW_CfgSetIncomingCallResultMode (UINT8 nMode);

UINT32
CFW_CfgGetIncomingCallResultMode (UINT8* nMode);
...
UINT32 SRVAPI
CFW_CfgSetAudioOutputParam (CFW_AUD_OUT_PARAMETER* pAudOutParam);

UINT32 SRVAPI
CFW_CfgGetAudioOutputParam (CFW_AUD_OUT_PARAMETER* pAudOutParam);

UINT32 SRVAPI
CFW_CfgSetAudioAudioMode (UINT8 nAudioMode);

UINT32 SRVAPI
CFW_CfgGetAudioAudioMode (UINT8* pAudioMode);

UINT32 SRVAPI
CFW_CfgSetLoudspeakerVolumeLevel (UINT8 nVolumeLevel);

UINT32 SRVAPI
CFW_CfgGetLoudspeakerVolumeLevel (UINT8* pVolumeLevel);

UINT32 SRVAPI
CFW_CfgGetLoudspeakerVolumeLevelRange (UINT8* pMinVolumeLevel,
				       UINT8* pMaxVolumeLevel);

UINT32 SRVAPI
CFW_CfgDeviceSwithOff (
VOID
);
...
UINT32 SRVAPI
CFW_NwGetAvailableOperators (UINT16 nUTI);

UINT32 SRVAPI
CFW_NwGetCurrentOperator (UINT8 OperatorId[6], UINT8* pMode);

UINT32 SRVAPI
CFW_NwGetImei (UINT16 nUTI);

UINT32 SRVAPI
CFW_NwGetSignalQuality (UINT8* pSignalLevel, UINT8* pBitError);

UINT32 SRVAPI
CFW_NwGetStatus (CFW_NW_STATUS_INFO* pStatusInfo);

UINT32 SRVAPI
CFW_NwSetRegistration (UINT8 nOperatorId[6], UINT8 nMode, UINT16 nUTI);

UINT32 SRVAPI
CFW_NwDeRegister (UINT16 nUTI);

UINT32
CFW_SetFlightMode (UINT8 bFM, UINT8 nUTI);

//fMode: 0 : nomal mode; 1: flight mode; 2: query mode
UINT32
CFW_WriteFlightMode (UINT8 fMode);

UINT32
CFW_GetFlightMode (UINT8 *pFM);

UINT32 SRVAPI
CFW_NwSetFrequencyBand (UINT8 nBand, UINT16 nUTI);

UINT32 SRVAPI
CFW_NwAbortListOperators (UINT16 nUTI);
...
UINT32 SRVAPI
CFW_CcGetCurrentCall (CFW_CC_CURRENT_CALL_INFO CallInfo[7], UINT8* pCnt);

UINT32 SRVAPI
CFW_CcCallHoldMultiparty (UINT8 nCmd, UINT8 nIndex);

UINT32 SRVAPI
CFW_CcInitiateSpeechCall (CFW_DIALNUMBER* pDialNumber, UINT16 nUTI);

UINT32 SRVAPI
CFW_CcEmcDial (UINT8* pNumber, UINT8 nSize);
...
UINT32 SRVAPI
CFW_SsQueryCallWaiting (UINT8 nClass, UINT16 nUTI);

UINT32 SRVAPI
CFW_SsSetCallWaiting (UINT8 nMode, UINT8 nClass, UINT16 nUTI //Hameina 2006.10.27 [add]:the original one has no nUTI
		      );

UINT32 SRVAPI
CFW_SsSetCallForwarding (CFW_SS_SET_CALLFORWARDING_INFO* pCallForwarding,
			 UINT16 nUTI);

UINT32 SRVAPI
CFW_SsQueryCallForwarding (UINT8 nReason, UINT8 nClass, UINT16 nUTI);
...
UINT32 SRVAPI
CFW_SsSetFacilityLock (UINT16 nFac, UINT8* pBufPwd, UINT8 nPwdSize,
		       UINT8 nClass, UINT8 nMode, UINT16 nUTI);

UINT32 SRVAPI
CFW_SsQueryFacilityLock (UINT16 nFac, UINT8 nClass, UINT16 nUTI);

UINT32 SRVAPI
CFW_SsChangePassword (UINT16 nFac, UINT8* pBufOldPwd, UINT8 nOldPwdSize,
		      UINT8* pBufNewPwd, UINT8 nNewPwdSize, UINT16 nUTI);

UINT32 SRVAPI
CFW_SsQueryClip (UINT16 nUTI);

UINT32 SRVAPI
CFW_SsQueryClir (UINT16 nUTI);

UINT32 SRVAPI
CFW_SsQueryColp (UINT16 nUTI);

UINT32 SRVAPI
CFW_SsQueryColr (UINT16 nUTI);

UINT32 SRVAPI
CFW_SsSendUSSD (UINT8* pUsdString, UINT8 nUsdStringSize, UINT8 nOption,
		UINT8 nDcs, UINT16 nUTI);
...
typedef struct _CFW_SAT_SMS_RSP
{    //for proactive command 0x13
  UINT8 nComID;
  UINT8 nComQualifier;
  UINT16 nAlphaLen;
  UINT8 *pAlphaStr;
...
typedef struct _CFW_SAT_DTEXT_RSP
{       //for proactive command 0x21
  UINT8 nComID;
  UINT8 nComQualifier;
  UINT8 nTextLen;
  UINT8 nTextSch;
...
typedef struct _CFW_SAT_POLL_INTERVAL_RSP
{       //for proactive command 0x21
  UINT8 nComID;
  UINT8 nComQualifier;
  UINT8 nTimeUnit;
...
typedef struct _CFW_SAT_INPUT_RSP
{       //for proactive command 0x23
  UINT8 nComID;
  UINT8 nComQualifier;
...
UINT32 SRVAPI
CFW_SimGetPbkMode (UINT16 nUTI);

UINT32 SRVAPI
CFW_SimSetPbkMode (UINT8 nPbkMode, UINT16 nUTI);
...
UINT32 SRVAPI
CFW_SimChangePassword (UINT16 nFac, UINT8* pBufOldPwd, UINT8 nOldPwdSize,
		       UINT8* pBufNewPwd, UINT8 nNewPwdSize, UINT16 nUTI);

UINT32 SRVAPI
CFW_SimGetAuthenticationStatus (UINT16 nUTI);

UINT32 SRVAPI
CFW_SimEnterAuthentication (UINT8* pPin, UINT8 nPinSize, UINT8* pNewPin,
			    UINT8 nNewPinSize, UINT8 nOption, UINT16 nUTI);

UINT32 SRVAPI
CFW_SimSetFacilityLock (UINT16 nFac, UINT8* pBufPwd, UINT8 nPwdSize,
			UINT8 nMode, UINT16 nUTI);

UINT32 SRVAPI
CFW_SimGetFacilityLock (UINT16 nFac, UINT16 nUTI);

UINT32 SRVAPI
CFW_SimGetProviderId (UINT16 nUTI);

UINT32 SRVAPI
CFW_SimSetPrefOperatorList (UINT8* pOperatorList, UINT8 nSize, UINT16 nUTI);

UINT32 SRVAPI
CFW_SimGetPrefOperatorListMaxNum (UINT16 nUTI);

UINT32 SRVAPI
CFW_SimGetPrefOperatorList (UINT16 nUTI);

UINT32 SRVAPI
CFW_SimAddPbkEntry (UINT8 nStorage, CFW_SIM_PBK_ENTRY_INFO* pEntryInfo,
		    UINT16 nUTI);

UINT32 SRVAPI
CFW_SimDeletePbkEntry (UINT8 nStorage, UINT8 nIndex, UINT16 nUTI);
UINT32 SRVAPI
CFW_SimGetServiceProviderName (UINT16 nUTI);

UINT32 SRVAPI
CFW_SimGetPbkEntry (UINT8 nStorage, UINT8 nIndex, UINT16 nUTI);

UINT32 SRVAPI
CFW_SimListPbkEntries (UINT8 nStorage, UINT8 nIndexStart, UINT8 nIndexEnd,
		       UINT16 nUTI);

UINT32 SRVAPI
CFW_SimListCountPbkEntries (UINT8 nStorage, UINT8 nIndexStart, UINT8 nCount,
			    UINT16 nUTI);

UINT32 SRVAPI
CFW_SimGetPbkStrorageInfo (UINT8 nStorage, UINT16 nUTI);

UINT32 SRVAPI
CFW_SimGetPbkStorage (UINT8 nStorage, UINT16 nUTI);

UINT32 SRVAPI
CFW_SatActivation (UINT8 nMode,
/*UINT8 nCharacter, */
UINT16 nUTI);

UINT32 SRVAPI
CFW_SatResponse (UINT8 nCmdType, UINT8 nStatus, UINT8 nItemId,
		 PVOID pInputString, UINT8 InputStrLen, UINT16 nUTI);

UINT32 SRVAPI
CFW_SatGetInformation (UINT8 nCmdType, PVOID* pCmdData);

UINT8
CFW_SatGetCurCMD (VOID);

UINT32
CFW_CfgSimGetMeProfile (CFW_PROFILE* pMeProfile);

UINT32
CFW_CfgSimSetMeProfile (CFW_PROFILE* pMeProfile);

VOID
CFW_GetMNCLen (UINT8 *pLen);
#endif
...
#ifndef CFW_MULTI_SIM
UINT32 SRVAPI
CFW_SmsDeleteMessage (UINT16 nIndex, UINT8 nStatus, UINT16 nStorage,
		      UINT16 nUTI);

UINT32 SRVAPI
CFW_SmsGetStorage (UINT16 nStorage, UINT16 nUTI);

UINT32 SRVAPI
CFW_SmsSetUnRead2Read (UINT16 nStorage, UINT16 nIndex, UINT16 nUTI);

UINT32 SRVAPI
CFW_SmsSetStorage (UINT16 nStorage1, UINT16 nStorage2, UINT16 nStorage3,
		   UINT16 nUTI);

UINT32 SRVAPI
CFW_SmsListMessages (UINT16 nStorage, UINT8 nStatus, UINT16 nCount,
		     UINT16 nStartIndex, UINT8 nOption, UINT16 nUTI);

UINT32 SRVAPI
CFW_SmsCopyMessages (UINT8 nStatus, UINT16 nCount, UINT16 nStartIndex,
		     UINT8 nOption, UINT16 nUTI);

UINT32 SRVAPI
CFW_SmsReadMessage (UINT16 nStorage, UINT16 nIndex, UINT16 nUTI);

UINT32 SRVAPI
CFW_SmsSetRead2UnRead (UINT16 nStorage, UINT16 nIndex, UINT16 nUTI);
UINT32 SRVAPI
CFW_SmsSendMessage (CFW_DIALNUMBER* pNumber, UINT8* pData, UINT16 nDataSize,
		    UINT16 nUTI);

UINT32 SRVAPI
CFW_SmsWriteMessage (CFW_DIALNUMBER* pNumber, UINT8* pData, UINT16 nDataSize,
		     UINT16 nStorage, UINT16 nIndex, UINT8 nStatus,
		     UINT16 nUTI);

UINT32 SRVAPI
CFW_SmsSetUnSent2Sent (UINT16 nStorage, UINT16 nIndex, UINT8 nSendStatus,
		       UINT16 nUTI);

UINT32 SRVAPI
CFW_SmsQueryOverflowInd (UINT8* pMode, UINT8* pStatus);

UINT32 SRVAPI
CFW_SmsNewSmsAck (UINT8 nCmd, UINT8* pData, UINT16 nSize);

UINT32 SRVAPI
CFW_SmsComposePdu (UINT8* pTpUd, // "ABC"
    UINT16 nTpUdl, // 3
...
UINT32 SRVAPI
CFW_SmsListMessagesHeader (UINT16 nStorage, UINT8 nStatus, UINT16 nCount,
			   UINT16 nStartIndex, UINT8 nOption, UINT16 nUTI);
UINT32 SRVAPI
CFW_SmsGetMessageNode (PVOID pListResult, UINT16 nIndex, CFW_SMS_NODE **pNode);

UINT32
CFW_SmsInitComplete (UINT16 nUTI);

UINT32
CFW_SetSMSConcat (BOOL bConcat);

UINT32
CFW_SmsAbortSendMessage (VOID);
...
UINT32 SRVAPI
CFW_PbkAddEntry (CFW_PBK_ENTRY_HRD* pEntryHrd, UINT16 nUTI);

UINT32 SRVAPI
CFW_PbkUpdateEntry (CFW_PBK_ENTRY_HRD* pEntryHrd, UINT16 nUTI);

UINT32 SRVAPI
CFW_PbkDeleteEntry (UINT8 nStorageId, UINT16 nPosition, UINT16 nUTI);

UINT32 SRVAPI
CFW_PbkDeleteBatchEntries (UINT16 nStartPos, UINT16 nCount, UINT8 nStorageId,
			   UINT16 nUTI);

UINT32 SRVAPI
CFW_PbkFindEntry (UINT8* pString, UINT8 nStringSize, UINT16 nStartPos,
		  UINT16 nCount, UINT8 nStorageId, UINT16 nGroup,
		  UINT16 nOption, UINT16 nUTI);

UINT32 SRVAPI
CFW_PbkListEntries (UINT16 nStartPos, UINT16 nPageCount, UINT16 nSkipPage,
		    UINT8 nStorageId, UINT16 nGroup, UINT8 nOption,
		    UINT16 nUTI);

UINT32 SRVAPI
CFW_PbkGetEntry (UINT16 nPosition, UINT8 nStorageId, UINT8 nOption,
		 UINT16 nUTI);

UINT32 SRVAPI
CFW_PbkCopyEntries (UINT16 nStartPos, UINT16 nCount, UINT8 nOption,
		    UINT16 nUTI);

UINT32 SRVAPI
CFW_PbkAddEntryItem (CFW_PBK_ENTRY_ITEM* pEntryItem, UINT8 nCount, UINT16 nUTI);

UINT32 SRVAPI
CFW_PbkGetEntryItems (UINT16 nPosition, UINT32 nItemGroupType, UINT16 nUTI);
//
//modify by lixp
//
#if 0
...
#endif
UINT32 SRVAPI
CFW_PbkDeleteEntryItem (UINT16 nItemId, UINT16 nUTI);

UINT32 SRVAPI
CFW_PbkGetCapacityInfo (UINT8 nStorageId, CFW_PBK_CAPACITY_INFO* pCapInfo);

UINT32 SRVAPI
CFW_PbkGetCalllogCapacityInfo (UINT8 nStorageId,
			       CFW_PBK_CAPACITY_INFO* pCapInfo);

UINT32 SRVAPI
CFW_PbkAddCallLogEntry (CFW_PBK_CALLLOG_ENTRY* pEntryInfo, UINT16 nUTI);
...
#endif
UINT32 SRVAPI
CFW_PbkGetCallLogEntry (UINT16 nPosition, UINT16 nUTI);

UINT32 SRVAPI
CFW_PbkListCallLogEntries (UINT16 nStartPosition, UINT16 nCount, UINT8 nStorage,
			   UINT16 nUTI);

UINT32 SRVAPI
CFW_PbkDeleteBatchCallLogEntries (UINT16 nStartPos, UINT16 nCount,
				  UINT8 nStorageId, UINT16 nUTI);
...
UINT32 SRVAPI
CFW_PbkCancel (UINT16 nOption, UINT16 nUTI);
...
INT32 CFW_TcpipGetRecvAvailable(SOCKET nSocket);
UINT32 CFW_TcpipGetLastError(VOID);
SOCKET CFW_TcpipSocket(UINT8 nDomain, UINT8 nType, UINT8 nProtocol);
INT32 CFW_TcpipSocketConnect(SOCKET nSocket, CFW_TCPIP_SOCKET_ADDR *pName, UINT8 nNameLen);
INT32 CFW_TcpipSocketSend(SOCKET nSocket, UINT8 *pData, UINT16 nDataSize, UINT32 nFlags);
INT32 CFW_TcpipSocketRecv(SOCKET nSocket, UINT8* pData, UINT16 nDataSize, UINT32 nFlags);
INT32 CFW_TcpipSocketClose(SOCKET nSocket);
INT32 CFW_TcpipSocketShutdownOutput(SOCKET nSocket, INT32 how);
INT32 CFW_TcpipSocketSendto(SOCKET nSocket, VOID *pData, UINT16 nDataSize, UINT32 nFlags, CFW_TCPIP_SOCKET_ADDR *to, INT32 tolen);
INT32 CFW_TcpipSocketRecvfrom(SOCKET nSocket, VOID *pMem, INT32 nLen, UINT32 nFlags, CFW_TCPIP_SOCKET_ADDR *from, INT32 * fromlen);
INT32 CFW_TcpipSocketBind(SOCKET nSocket, CFW_TCPIP_SOCKET_ADDR *pName, UINT8 nNameLen);
INT32 CFW_TcpipSocketListen(SOCKET nSocket, UINT32 backlog);
INT32 CFW_TcpipSocketAccept(SOCKET nSocket, CFW_TCPIP_SOCKET_ADDR *addr, UINT32 * addrlen);
...
#endif
INT32 CFW_TcpipSocketConnectEx(SOCKET nSocket, CFW_TCPIP_SOCKET_ADDR *pName, UINT8 nNameLen
#ifdef CFW_MULTI_SIM
    , CFW_SIM_ID nSimID
#endif
);
...
//
UINT32 SRVAPI
CFW_MeChangePassword (UINT16 nFac, UINT8* pBufPwd, UINT8 nPwdSize, UINT8 nMode,
		      UINT16 nUTI);

UINT32 SRVAPI
CFW_MeGetFacilityLock (UINT16 nFac, UINT16 nUTI);

UINT32 SRVAPI
CFW_MeSetFacilityLock (UINT16 nFac, UINT8* pBufPwd, UINT8 nPwdSize, UINT8 nMode,
		       UINT16 nUTI);
...
//
typedef UINT32
(*PFN_KL_SENDMESSAGDE2APP) (UINT32 nEventId, VOID* pData, UINT32 nSize);
typedef UINT32
(*PFN_KL_SENDMESSAGDE_EX) (UINT32 nMailBox, UINT32 nEventId,
VOID* pData,
			   UINT32 nSize);
typedef PVOID
(*PFN_KL_MALLOC) (UINT32 nSize);
typedef BOOL
(*PFN_KL_FREE) (PVOID nAddr);
typedef BOOL
(*PFN_KL_IS_VALIDHEAP) (VOID* pData, UINT32 nSize);
typedef BOOL
(*PFN_AUD_START_SPK_MIC) (VOID);
typedef BOOL
(*PFN_AUD_STOP_SPK_MIC) (VOID);
...
BOOL
CFW_EmodGetBatteryInfo (CFW_EMOD_BATTERY_INFO* pBatInfo);

void
CFW_EmodAudioTestStart (UINT8 type); //type value: 0 is normal; 1 is mic AUX and speak AUX; 2 is mic loud and speak loud.

void
CFW_EmodAudioTestEnd (void);

BOOL
CFW_EmodClearUserInfo (void);  	//return TRUE is success,and FALSE is failure.
#ifdef CFW_MULTI_SIM
    void CFW_EmodGetIMEI(UINT8* pImei,UINT8* pImeiLen,CFW_SIM_ID nSimID); //pImei is the buffer that
#else
void
CFW_EmodGetIMEI (UINT8* pImei, UINT8* pImeiLen);  //pImei is the buffer that
#endif
//
//bind 
//
...
void
CFW_EmodReadBindSIM (CFW_EMOD_READ_BIND_SIM* pReadBindSim);

void
CFW_EmodReadBindNW (CFW_EMOD_READ_BIND_NW* pReadBindNw);

void
CFW_EmodGetBindInfo (BOOL* bSim, BOOL* bNetWork); //ture: had been bond.false:not bind

UINT32
CFW_EmodSetBindInfo (BOOL bSim, BOOL bNetWork);
...
CFW_EMOD_UPDATE_RETURN
CFW_EmodUpdateSimBind (UINT8 nIndex, UINT8* pBindSimNum, UINT8 nLen);

CFW_EMOD_UPDATE_RETURN
CFW_EmodUpdateNwBind (UINT8 nIndex, UINT8* pBindNwNum, UINT8 nLen);
...
void
CFW_EmodGetProductInfo (CFW_EMOD_LOCT_PRODUCT_INFO* pProduct);
...
void
CFW_EmodGetRFCalibrationInfo (CFW_EMOD_RF_CALIB_INFO *pRfCalib);
...
#else
UINT32 SRVAPI
CFW_EmodOutfieldTestStart (CFW_TSM_FUNCTION_SELECT* pSelecFUN, UINT16 nUTI);
UINT32 SRVAPI
CFW_EmodOutfieldTestEnd (UINT16 nUTI);
#endif
#ifdef CFW_MULTI_SIM
UINT32 CFW_GetCellInfo(CFW_TSM_CURR_CELL_INFO *pCurrCellInfo, CFW_TSM_ALL_NEBCELL_INFO *pNeighborCellInfo,CFW_SIM_ID nSimID);
#else
UINT32
CFW_GetCellInfo (CFW_TSM_CURR_CELL_INFO *pCurrCellInfo,
...
typedef enum
{
  PHY_VERSION, STACK_VERSION, PHY_CFG_VERSION, CSW_VERSION, MMI_VERSION
} SOFT_VERSION;

typedef enum
{
  XCV_VERSION, PA_VERSION, SW_VERSION, CHIP_VERSION, FLASH_VERSION
} HW_VERSION;
...
reg_GetRegSize (VOID);
INT32
REG_Read (UINT32 ulAddrOffset, UINT8* pBuffer, UINT32 ulBytesToRead,
	  UINT32* pBytesRead);
INT32
REG_Write (UINT32 ulAddrOffset, CONST UINT8* pBuffer, UINT32 ulBytesToWrite,
	   UINT32* pBytesWritten);

UINT32
ML_Init ();
UINT32
ML_SetCodePage (UINT8 nCharset[12]);

UINT32
ML_LocalLanguage2Unicode (const UINT8* in, UINT32 in_len, UINT8** out,
			  UINT32* out_len, UINT8 nCharset[12]);
UINT32
ML_Unicode2LocalLanguage (const UINT8* in, UINT32 in_len, UINT8** out,
			  UINT32* out_len, UINT8 nCharset[12]);
UINT32
ML_LocalLanguage2UnicodeBigEnding (const UINT8* in, UINT32 in_len, UINT8** out,
				   UINT32* out_len, UINT8 nCharset[12]);

//hameina[+]20081031 for bug 10176
//
VOID
CFW_CcSetCSSI (BOOL nCSSI);
VOID
CFW_CcSetCSSU (BOOL nCSSU);
...
UINT32
CFW_GetFreeCID (UINT8* pCID);
UINT32
CFW_ReleaseCID (UINT8 nCID);
UINT32
CFW_SetCID (UINT8 nCID);
BOOL
CFW_isPdpActiveAvailable (VOID);
