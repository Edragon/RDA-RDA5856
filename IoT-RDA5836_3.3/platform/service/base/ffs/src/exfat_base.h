...
#define EXFAT_FBR_PARTITIONOFFSET_SIZE               sizeof(UINT64)

#define EXFAT_FBR_VALUEMLENGTH_POS                     (EXFAT_FBR_PARTITIONOFFSET_POS + EXFAT_FBR_PARTITIONOFFSET_SIZE)
#define EXFAT_FBR_VALUEMLENGTH_SIZE                    sizeof(UINT64)
...
#define _ERR_FAT_NO_DIRECTORY_CACHE                             -1050
#define _ERR_FAT_DIRECTORY_CACHE_PARAM_ERROR          -1051
#define _ERR_FAT_DIRECTORY_CACHE_IS_FULL                    -1052
