...
#define BOOT_USB_PRODUCT_ID(usbMode)  ((CHIP_ASIC_ID_GALLITE << 8) | (((usbMode)&0x07) << 5) | GET_BITFIELD(hwp_configRegs->CHIP_ID, CFG_REGS_BOND_ID))
    ...
    #else
        #define BOOT_USB_PRODUCT_ID(usbMode)  ((CHIP_ASIC_ID << 8) | (((usbMode)&0x07) << 5) | GET_BITFIELD(hwp_configRegs->chip_id, CFG_REGS_EXT_PROD_ID))
    #endif    
#endif
