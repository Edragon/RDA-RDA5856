...
//Build_Version
#define CFG_REG_DAY(n)                 (((n)&0xFF)<<0)     
#define CFG_REG_MONTH(n)               (((n)&0xFF)<<8)     
#define CFG_REG_YEAR(n)                (((n)&0xFF)<<16)    
#define CFG_REG_MAJOR(n)               (((n)&0xFF)<<24)    
...
//audio_head_gain
#define CFG_REGS_AU_HEAD_GAIN_MASK    (7<<5)
