...
/// System side divided clock (either divided by module or by sys_ctrl)
    ...
    SYS_A2A_BT                                  = 0x0000001F,
/// the following don't have an auto enable
    SYS_GPIO                                    = 0x00000020,
    SYS_IRQ                                     = 0x00000021,
    SYS_TCU                                     = 0x00000022,
    SYS_TIMER                                   = 0x00000023,
    SYS_BT                                      = 0x00000024,
/// the following are sharing their enable
    SYS_SCI                                     = 0x00000025,
/// keep last
    SYS_NOGATE                                  = 0x00000026
} SYS_CLKS_T;

#define NB_SYS_CLK_XCPU                          (2)
#define NB_SYS_CLK_AEN                           (32)
#define NB_SYS_CLK_EN                            (37)
#define NB_SYS_CLK                               (39)
...
typedef volatile struct
{
    ...
    REG32                          BT_Cfg;                       //0x000000BC
    REG32                          bt_btcpu_1;                   //0x000000C0    
    REG32                          bt_btcpu_2;                   //0x000000C4    
    REG32                          reserved[8];
    REG32                          usb_cfg;                      //0x000000E8    
    REG32                          mbist_ctrl;                   //0x000000EC    
    REG32                          rom0_mbist;                   //0x000000F0    
    REG32                          rom1_mbist;                   //0x000000F4    
    REG32                          RAM_CTRL;                     //0x000000F8    
...
#define SYS_CTRL_SET_RST_SCI2       (1<<3)
...
#define SYS_CTRL_SET_RST_BT         (1<<23)
...
#define SYS_CTRL_CLR_RST_SCI2       (1<<3)
...
#define SYS_CTRL_CLR_RST_BT         (1<<23)
...
#define SYS_CTRL_MODE_SYS_A2A_BT_AUTOMATIC (0<<31)
#define SYS_CTRL_MODE_SYS_A2A_BT_MANUAL (1<<31)
#define SYS_CTRL_MODE_CLK_SYS(n)    (((n)&0x7FFFFFFF)<<1)
#define SYS_CTRL_MODE_CLK_SYS_MASK  (0x7FFFFFFF<<1)
...
#define SYS_CTRL_ENABLE_SYS_A2A_BT  (1<<31)
...
#define SYS_CTRL_DISABLE_SYS_A2A_BT (1<<31)
...
#define SYS_CTRL_ENABLE_PER_USB_ROLE_DET      (1<<14)
...
#define SYS_CTRL_ENABLE_OC_BT26M    (1<<19)
#define SYS_CTRL_ENABLE_OC_BT32K    (1<<20)
#define SYS_CTRL_ENABLE_OC_CACHE_AHB    (1<<21)
#define SYS_CTRL_ENABLE_OC_CACHE_AHB_ARB    (1<<22)
#define SYS_CTRL_ENABLE_OC_AHB_TIMEOUT_MON      (1<<23)
#define SYS_CTRL_ENABLE_OC_SYS_SPIFLASH    (1<<24)
#define SYS_CTRL_ENABLE_OC_SPIFLASH    (1<<25)
#define SYS_CTRL_ENABLE_CLK_OTHER(n) (((n)&0x3FFFFFF)<<0)
#define SYS_CTRL_ENABLE_CLK_OTHER_MASK (0x3FFFFFF<<0)
...
#define SYS_CTRL_DISABLE_OC_BT26M    (1<<19)
#define SYS_CTRL_DISABLE_OC_BT32K    (1<<20)
#define SYS_CTRL_DISABLE_OC_CACHE_AHB    (1<<21)
#define SYS_CTRL_DISABLE_OC_CACHE_AHB_ARB    (1<<22)
#define SYS_CTRL_DISABLE_OC_AHB_TIMEOUT_MON      (1<<23)
#define SYS_CTRL_DISABLE_OC_SYS_SPIFLASH    (1<<24)
#define SYS_CTRL_DISABLE_OC_SPIFLASH    (1<<25)
#define SYS_CTRL_DISABLE_CLK_OTHER(n) (((n)&0x3FFFFFF)<<0)
#define SYS_CTRL_DISABLE_CLK_OTHER_MASK (0x3FFFFFF<<0)
...
#define SYS_CTRL_MEM_DDR_DQSL_I(n)  (((n)&7)<<8)
#define SYS_CTRL_MEM_DDR_DQSU_I(n)  (((n)&7)<<11)
#define SYS_CTRL_MEM_DDR_DQSL_O(n)  (((n)&7)<<14)
#define SYS_CTRL_MEM_DDR_DQSU_O(n)  (((n)&7)<<17)
#define SYS_CTRL_MEM_DDR_PLL_OFF    (1<<20)
...
#define SYS_CTRL_CLKOUT_SEL_DIVIDER (1<<9)
#define SYS_CTRL_CLKOUT_DEBUG        (1<<12)


//Cfg_Clk_BB
#define SYS_CTRL_BB_FREQ(n)         (((n)&0xF)<<0)
#define SYS_CTRL_BB_FREQ_MASK       (0xF<<0)
...
#define SYS_CTRL_BB_FREQ_69M        (8<<0)
#define SYS_CTRL_BB_FREQ_62M        (9<<0)
...
#define SYS_CTRL_AIF_TX_STB_CODEC_EN (1<<29)
#define SYS_CTRL_AIF_TX_STB_26M_EN  (1<<30)
...
//Cfg_Clk_PWM
#define SYS_CTRL_PWM_DIVIDER(n)     (((n)&0x3FF)<<0)
...
#define SYS_CTRL_ENABLE_SYS_MID_AHB2AHB_BT_ENABLE (1<<10)
#define SYS_CTRL_ENABLE_SYS_MID_AHB2AHB_BT_DISABLE (0<<10)
...
#define SYS_CTRL_SYS_ENABLE(n)      (((n)&0x3FF)<<1)
#define SYS_CTRL_SYS_ENABLE_MASK    (0x3FF<<1)
...
#define SYS_CTRL_SPLIT_SYS_MID_AHB2AHB_BT_NORMAL (1<<9)
#define SYS_CTRL_SPLIT_SYS_MID_AHB2AHB_BT_FORCE (0<<9)
...
#define SYS_CTRL_SYS_FORCE_HSPLIT(n) (((n)&0x3FF)<<0)
#define SYS_CTRL_SYS_FORCE_HSPLIT_MASK (0x3FF<<0)
...
#define SYS_CTRL_SD_PLL_OFF            (1<<17)             
#define SYS_CTRL_SD_DQSL_I(n)          (((n)&0x3)<<18)     
#define SYS_CTRL_SD_DQSU_I(n)          (((n)&0x3)<<20)     
#define SYS_CTRL_SD_DQSL_O(n)          (((n)&0x3)<<22)     
#define SYS_CTRL_SD_DQSU_O(n)          (((n)&0x3)<<24)     
#define SYS_CTRL_SD_OEN(n)             (((n)&0x3)<<26)     
#define SYS_CTRL_MPMC_DQS_SINGLE       (1<<28)             
...
#define SYS_CTRL_ENABLE_SYS_BT      (1<<4)
#define SYS_CTRL_ENABLE_CLK_SYS2(n) (((n)&0x1F)<<0)
#define SYS_CTRL_ENABLE_CLK_SYS2_MASK (0x1F<<0)
...
#define SYS_CTRL_DISABLE_SYS_BT     (1<<4)
#define SYS_CTRL_DISABLE_CLK_SYS2(n) (((n)&0x1F)<<0)
#define SYS_CTRL_DISABLE_CLK_SYS2_MASK (0x1F<<0)
#define SYS_CTRL_DISABLE_CLK_SYS2_SHIFT (0)

//BT_Cfg
#define SYS_CTRL_BT_COMPRESS_EN     (1<<0)
#define SYS_CTRL_BT_SRAM_DVSE       (1<<1)
#define SYS_CTRL_BT_SRAM_DVS(n)     (((n)&7)<<2)
#define SYS_CTRL_BT_SRAM_DVS_MASK   (7<<2)
#define SYS_CTRL_BT_SRAM_DVS_SHIFT  (2)
#define SYS_CTRL_BT_DPRAM_DVSE      (1<<5)
#define SYS_CTRL_BT_DPRAM_DVS(n)    (((n)&0xF)<<6)
#define SYS_CTRL_BT_DPRAM_DVS_MASK  (0xF<<6)
#define SYS_CTRL_BT_DPRAM_DVS_SHIFT (6)
#define SYS_CTRL_BT_WAKEBT          (1<<10)
#define SYS_CTRL_BT_DATA2BT         (1<<11)
#define SYS_CTRL_BT_DATAIN_READY    (1<<12)
#define SYS_CTRL_BT_WAKE_STATUS     (1<<13)
#define SYS_CTRL_BT_DATAIN_STATUS   (1<<14)
#define SYS_CTRL_BT_INT_EX_STATUS   (1<<15)
#define SYS_CTRL_BT_IRQ_MASK(n)     (((n)&7)<<16)
#define SYS_CTRL_BT_IRQ_MASK_MASK   (7<<16)
#define SYS_CTRL_BT_IRQ_MASK_SHIFT  (16)
#define SYS_CTRL_BT_IRQ_MASK_WAKE   (1<<16)
#define SYS_CTRL_BT_IRQ_MASK_DATAIN (1<<17)
#define SYS_CTRL_BT_IRQ_MASK_INT_EX (1<<18)

//usb_cfg
#define SYS_CTRL_USB_ID                (1<<0)              
#define SYS_CTRL_USB_PLL_PU            (1<<1)              

//mbist_ctrl
#define SYS_CTRL_MBIST_CLK_AUTO_CTRL   (1<<0)              

//rom0_mbist
#define SYS_CTRL_CRC_VALUE(n)          (((n)&0xFFFFFFFF)<<0)

//rom1_mbist
#define SYS_CTRL_CRC_VALUE(n)          (((n)&0xFFFFFFFF)<<0)

//RAM_CTRL
#define SYS_CTRL_RAM_CLK_FORCE_ON      (1<<0)              
#define SYS_CTRL_RAM_DVSE              (1<<1)              
#define SYS_CTRL_RAM_DVS(n)            (((n)&0x7)<<2)      
#define SYS_CTRL_DPRAM_DVSE            (1<<5)              
#define SYS_CTRL_DPRAM_DVS(n)          (((n)&0xF)<<6)      
#define SYS_CTRL_ROM_DVSE              (1<<10)             
#define SYS_CTRL_ROM_DVS(n)            (((n)&0xF)<<11)   

//Cfg_Reserved
#define SYS_CTRL_RESERVED_0            (1<<0)

//Cfg_Reserved
#define SYS_CTRL_FM_I2C_ADDR(n)        (((n)&0x7F)<<16)    
#define SYS_CTRL_AHB_MON_IRQ_CLR       (1<<23)             
#define SYS_CTRL_VOC_AHB_BRG_EN        (1<<24)             
#define SYS_CTRL_UART1_TCO             (1<<0)//added for hal_config() in 5855
