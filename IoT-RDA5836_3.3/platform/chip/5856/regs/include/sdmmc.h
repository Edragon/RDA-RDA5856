...
typedef volatile struct
{
    ...
    REG32                          sd_config;                 //0x00000800
    REG32                          sd_status;                 //0x00000804
    REG32                          sd_cmd_index;              //0x00000808
    REG32                          sd_cmd_arg;                //0x0000080C
    REG32                          sd_rsp_index;             //0x00000810
    REG32                          sd_rsp_arg3;              //0x00000814
    REG32                          sd_rsp_arg2;              //0x00000818
    REG32                          sd_rsp_arg1;              //0x0000081C
    REG32                          sd_rsp_arg0;              //0x00000820
    REG32                          sd_data_width;             //0x00000824
    REG32                          sd_block_size;             //0x00000828
    REG32                          sd_block_cnt;              //0x0000082C
    REG32                          sd_int_status;             //0x00000830
    REG32                          sd_int_mask;               //0x00000834
    REG32                          sd_int_clear;              //0x00000838
    REG32                          sd_trans_speed;            //0x0000083C
    REG32                          sd_mclk_adjust;            //0x00000840
} HWP_SDMMC_T;
