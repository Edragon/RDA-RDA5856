...
typedef enum
{
    ...
    SYS_SID_AHB2AHB_BT                          = 0x0000000d
} SYS_SLAVE_ID_T;

#define SYS_SID_END                              (14)
...
/// The following modules are linked to ifc dma req with 2 requests per module
    ...
    SYS_ID_SCI2                                 = 0x0000001a,
    SYS_ID_SCI3                                 = 0x0000001b,
    SYS_ID_XCPU_REG                             = 0x0000001c,
    SYS_ID_XCPU_TAG                             = 0x0000001d,
    SYS_ID_XCPU_IDATA                           = 0x0000001e,
    SYS_ID_XCPU_DDATA                           = 0x0000001f,
    SYS_ID_SYS_AHBC_MON                         = 0x00000020,
    SYS_ID_BB_AHBC_MON                          = 0x00000021,
    SYS_ID_IFC2                                 = 0x00000022,
    SYS_ID_GOUDA                                = 0x00000023,
    SYS_ID_I2C2                                 = 0x00000024,
    SYS_ID_I2C3                                 = 0x00000025,
    SYS_ID_EXT_APB                              = 0x00000026,
    SYS_ID_SPIFLASH                             = 0x00000027,
    SYS_ID_NF                                   = 0x00000028,
    SYS_ID_NF1                                  = 0x00000029,
    SYS_ID_NF2                                  = 0x0000002a,
    SYS_ID_NF3                                  = 0x0000002b,
    SYS_ID_RS                                   = 0x0000002c,
    SYS_ID_BIST                                 = 0x0000002d
} SYS_MODULE_ID_T;

#define FIRST_SYS_ID_DATA                        (14)
#define LAST_SYS_ID_DATA                         (28)
#define SYS_NB_PSEL                              (46)
...
typedef enum
{
    ...
    SYS_ID_TX_SCI2                              = 0x00000014,
    SYS_ID_RX_SCI2                              = 0x00000015,
    SYS_ID_TX_SCI3                              = 0x00000016,
    SYS_ID_RX_SCI3                              = 0x00000017
} SYS_IFC_REQUEST_IDS_T;

#define SYS_NB_DMA_REQ                           (24)
...
/// System IRQ IDs
/// Pulse IRQ
    SYS_IRQ_BT_TIMER1                           = 0x00000000,
    SYS_IRQ_BT_TIMER0                           = 0x00000001,
    SYS_IRQ_BT_TIMER3                           = 0x00000002,
    SYS_IRQ_BT_TIMER2                           = 0x00000003,
    SYS_IRQ_BT_AUX_TIMER                        = 0x00000004,
    SYS_IRQ_BT_PKA                              = 0x00000005,
    SYS_IRQ_BT_RX_TIMEOUT                       = 0x00000006,
    SYS_IRQ_BT_PKD                              = 0x00000007,
    SYS_IRQ_BT_RX_HEADER                        = 0x00000008,
    SYS_IRQ_BT_RX_SYNC                          = 0x00000009,
    SYS_IRQ_BT_PCM_SYNC                         = 0x0000000A,
    SYS_IRQ_BT_MULTI_LINK0                      = 0x0000000B,
    SYS_IRQ_BT_MULTI_LINK1                      = 0x0000000C,
    SYS_IRQ_USBC                                = 0x0000000D,
    SYS_IRQ_VOC                                 = 0x0000000E,
    SYS_IRQ_USELESS                             = 0x0000000F,
    SYS_IRQ_BBIFC0                              = 0x00000010,
    SYS_IRQ_BBIFC1                              = 0x00000011,
    SYS_IRQ_FM_DSP                              = 0x00000012,
    SYS_IRQ_GPIO                                = 0x00000013,
    SYS_IRQ_UART                                = 0x00000014,
    SYS_IRQ_IR                                  = 0x00000015,
    SYS_IRQ_USB_DET                             = 0x00000016,
    SYS_IRQ_I2C                                 = 0x00000017,
    SYS_IRQ_CALENDAR                            = 0x00000018,
    SYS_IRQ_PWM                                 = 0x00000019,
    SYS_IRQ_SDMMC                               = 0x0000001A,
    SYS_IRQ_SPI1                                = 0x0000001B,
    SYS_IRQ_DEBUG_UART                          = 0x0000001C,
    SYS_IRQ_DMA                                 = 0x0000001D,
    SYS_IRQ_TIMERS                              = 0x0000001E,
