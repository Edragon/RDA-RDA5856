...
#define SYS_ID_SCI2                              (26)
#define SYS_ID_SCI3                              (27)
#define LAST_SYS_ID_DATA                         (28)
#define SYS_ID_XCPU_REG                          (28)
#define SYS_ID_XCPU_TAG                          (29)
#define SYS_ID_XCPU_IDATA                        (30)
#define SYS_ID_XCPU_DDATA                        (31)
#define SYS_ID_SYS_AHBC_MON                      (32)
#define SYS_ID_BB_AHBC_MON                       (33)
#define SYS_ID_IFC2                              (34)
#define SYS_ID_GOUDA                             (35)
#define SYS_ID_I2C2                              (36)
#define SYS_ID_I2C3                              (37)
#define SYS_ID_EXT_APB                           (38)
#define SYS_ID_SPIFLASH                          (39)
#define SYS_ID_NF                                (40)
#define SYS_ID_NF1                               (41)
#define SYS_ID_NF2                               (42)
#define SYS_ID_NF3                               (43)
#define SYS_ID_RS                                (44)
#define SYS_ID_BIST                              (45)
...
#define SYS_ID_TX_SCI2                           (20)
#define SYS_ID_RX_SCI2                           (21)
#define SYS_ID_TX_SCI3                           (22)
#define SYS_ID_RX_SCI3                           (23)
#define SYS_NB_DMA_REQ                           (24)
/// System IRQ IDs
/// Pulse IRQ
#define SYS_IRQ_BT_TIMER1                        (0)
#define SYS_IRQ_BT_TIMER0                        (1)
#define SYS_IRQ_BT_TIMER3                        (2)
#define SYS_IRQ_BT_TIMER2                        (3)
#define SYS_IRQ_BT_AUX_TIMER                     (4)
#define SYS_IRQ_BT_PKA                           (5)
#define SYS_IRQ_BT_RX_TIMEOUT                    (6)
#define SYS_IRQ_BT_PKD                           (7)
#define SYS_IRQ_BT_RX_HEADER                     (8)
#define SYS_IRQ_BT_RX_SYNC                       (9)
#define SYS_IRQ_BT_PCM_SYNC                      (10)
#define SYS_IRQ_BT_MULTI_LINK0                   (11)
#define SYS_IRQ_BT_MULTI_LINK1                   (12)
#define SYS_IRQ_USBC                             (13)
#define SYS_IRQ_VOC                              (14)
#define SYS_IRQ_USELESS                          (15)
#define SYS_IRQ_BBIFC0                           (16)
#define SYS_IRQ_BBIFC1                           (17)
#define SYS_IRQ_FM_DSP                           (18)
#define SYS_IRQ_GPIO                             (19)
#define SYS_IRQ_UART                             (20)
#define SYS_IRQ_IR                               (21)
#define SYS_IRQ_USB_DET                          (22)
#define SYS_IRQ_I2C                              (23)
#define SYS_IRQ_CALENDAR                         (24)
#define SYS_IRQ_PWM                              (25)
#define SYS_IRQ_SDMMC                            (26)
#define SYS_IRQ_SPI1                             (27)
#define SYS_IRQ_DEBUG_UART                       (28)
#define SYS_IRQ_DMA                              (29)
#define SYS_IRQ_TIMERS                           (30)
