...
//#define hwp_vocCfg                  ((T_HWP_VOC_CFG_T*) KSEG1(REG_VOC_CFG_BASE))
...
//DMA_Wrap
#define VOC_CFG_DMA_WRAP(n)         (((n)&15)<<16)

//DMA_Size
#define VOC_CFG_DMA_SIZE(n)         (((n)&0x3FFF)<<0)

//DMA_Laddr
#define VOC_CFG_DMA_LADDR(n)        (((n)&0xFFFF)<<16)
...
//Debug
#define VOC_CFG_STALL_ON_BKP        (1<<16)
#define VOC_CFG_STALL_ON_BRANCH_TAKEN (1<<17)
#define VOC_CFG_STEP                (1<<18)
...
#define VOC_CFG_IFC0_EVENT_CAUSE       (1<<16)             

#define VOC_CFG_IFC1_EVENT_CAUSE       (1<<17)             

#define VOC_CFG_DMAE_EVENT_CAUSE       (1<<18)             

#define VOC_CFG_DMAI_EVENT_CAUSE       (1<<19)             

#define VOC_CFG_SOF0_EVENT_CAUSE       (1<<20)             

#define VOC_CFG_SOF1_EVENT_CAUSE       (1<<21)             
...
//RA
#define VOC_CFG_RA(n)               (((n)&0xFFFF)<<16)

//SP16
#define VOC_CFG_SP16(n)             (((n)&0xFFFF)<<0)

//SP32
#define VOC_CFG_SP32(n)             (((n)&0xFFFF)<<17)
...
//LOOP
#define VOC_CFG_LOOP0(n)            (((n)&0xFF)<<16)
#define VOC_CFG_LOOP1(n)            (((n)&0xFF)<<24)
