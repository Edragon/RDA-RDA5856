...
void sxr_InitQueue (void)
{
    ...
    if(InitDone == FALSE)
    {
        sxr_QueueDesc = sxr_HMalloc(SXR_NB_MAX_QUEUE*sizeof(sxr_QueueDesc_t));

        sxr_QueueEnv = sxr_HMalloc(SXR_NB_QUEUE_ENVELOPPE*sizeof(sxr_QueueEnv_t));
        ...
        for (i=0; i<SXR_NB_MAX_QUEUE; i++)
        {
            ...
            sxr_QueueDesc [i].Cur = sxr_HMalloc(SXR_NB_MAX_USR_QUEUE*sizeof(u16));
            sxr_QueueDesc [i].Prev = sxr_HMalloc(SXR_NB_MAX_USR_QUEUE*sizeof(u16));
